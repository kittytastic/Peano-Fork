...
class GlobalFixedTimeStepWithEnclaveTasking( EnclaveTasking ):
  def __init__(self, 
    ...
    """
    super(GlobalFixedTimeStepWithEnclaveTasking,self).__init__(name, patch_size, unknowns, auxiliary_variables, min_volume_h, max_volume_h, plot_grid_properties,stateless_pde_terms) 
