...
using namespace project::base_2d_euler_inline;
...
int main(int argc, char** argv) {
  ...
  project::base_2d_euler_inline::repositories::DataRepository::initDatatypes();
  ...
  project::base_2d_euler_inline::repositories::DataRepository::shutdownDatatypes();
