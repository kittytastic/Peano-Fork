...
//
#ifndef _project_base_2d_euler_inline_facedata_euler2DQOld_H_
#define _project_base_2d_euler_inline_facedata_euler2DQOld_H_
...
struct project::base_2d_euler_inline::facedata::euler2DQOld {
  #if PeanoDebug>=1
  private:
