...
//
#ifndef _project_base_2d_euler_inline_facedata_euler2DQUpdate_H_
#define _project_base_2d_euler_inline_facedata_euler2DQUpdate_H_
...
struct project::base_2d_euler_inline::facedata::euler2DQUpdate {
  #if PeanoDebug>=1
  private:
