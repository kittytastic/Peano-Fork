...
//
#ifndef _project_base_2d_euler_inline_Abstracteuler2D_H_
#define _project_base_2d_euler_inline_Abstracteuler2D_H_
...
namespace project {namespace base_2d_euler_inline {
  class Abstracteuler2D;

}}



class project::base_2d_euler_inline::Abstracteuler2D: public ::exahype2::Solver {
  public:
    /**
    ...
    static constexpr int  NumberOfFiniteVolumesPerAxisPerPatch = 3;
     ...
     */
    static constexpr double MaxAdmissiblePatchH  = 0.01 * NumberOfFiniteVolumesPerAxisPerPatch;
    static constexpr double MaxAdmissibleVolumeH = 0.01;
     ...
     * coarser MinH.
     */
    static constexpr double MinAdmissiblePatchH  = 0 * NumberOfFiniteVolumesPerAxisPerPatch;
    static constexpr double MinAdmissibleVolumeH = 0;
