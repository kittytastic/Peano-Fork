...
tarch::logging::Log project::base_2d_euler_inline::observers::CreateGrid::_log( "project::base_2d_euler_inline::observers::CreateGrid" );



project::base_2d_euler_inline::observers::CreateGrid::CreateGrid(int spacetreeId):
...
peano4::grid::TraversalObserver* project::base_2d_euler_inline::observers::CreateGrid::clone(int spacetreeId) {
  return new CreateGrid(spacetreeId);
}

  

std::vector< peano4::grid::GridControlEvent > project::base_2d_euler_inline::observers::CreateGrid::getGridControlEvents() const {
...
void project::base_2d_euler_inline::observers::CreateGrid::beginTraversal( const tarch::la::Vector<Dimensions,double>&  x, const tarch::la::Vector<Dimensions,double>&  h ) {
...
void project::base_2d_euler_inline::observers::CreateGrid::endTraversal( const tarch::la::Vector<Dimensions,double>&  x, const tarch::la::Vector<Dimensions,double>&  h ) {
...
void project::base_2d_euler_inline::observers::CreateGrid::loadCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void project::base_2d_euler_inline::observers::CreateGrid::enterCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void project::base_2d_euler_inline::observers::CreateGrid::leaveCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void project::base_2d_euler_inline::observers::CreateGrid::storeCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void project::base_2d_euler_inline::observers::CreateGrid::exchangeAllVerticalDataExchangeStacks( int masterId ) {
...
void project::base_2d_euler_inline::observers::CreateGrid::exchangeAllHorizontalDataExchangeStacks( bool symmetricDataCardinality ) {
...
void project::base_2d_euler_inline::observers::CreateGrid::exchangeAllPeriodicBoundaryDataStacks() {
...
void project::base_2d_euler_inline::observers::CreateGrid::streamDataFromSplittingTreeToNewTree(int newWorker) {
...
void project::base_2d_euler_inline::observers::CreateGrid::streamDataFromJoiningTreeToMasterTree(int master) {
...
void project::base_2d_euler_inline::observers::CreateGrid::finishAllOutstandingSendsAndReceives() {
...
void project::base_2d_euler_inline::observers::CreateGrid::sendVertex(int position, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::grid::GridTraversalEvent&  event) {
...
void project::base_2d_euler_inline::observers::CreateGrid::sendFace(int position, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::grid::GridTraversalEvent&  event) {
...
void project::base_2d_euler_inline::observers::CreateGrid::sendCell(int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::grid::GridTraversalEvent&  event) {
...
void project::base_2d_euler_inline::observers::CreateGrid::receiveAndMergeCell(int fromStack, SendReceiveContext context, const peano4::grid::GridTraversalEvent& event ) {
...
void project::base_2d_euler_inline::observers::CreateGrid::receiveAndMergeFace(int position, int fromStack, SendReceiveContext context, const peano4::grid::GridTraversalEvent& event) {
...
void project::base_2d_euler_inline::observers::CreateGrid::receiveAndMergeVertex(int position, int fromStack, SendReceiveContext context, const peano4::grid::GridTraversalEvent& event) {
...
void project::base_2d_euler_inline::observers::CreateGrid::deleteAllStacks() {
