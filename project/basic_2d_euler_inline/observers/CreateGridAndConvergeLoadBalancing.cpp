...
tarch::logging::Log project::base_2d_euler_inline::observers::CreateGridAndConvergeLoadBalancing::_log( "project::base_2d_euler_inline::observers::CreateGridAndConvergeLoadBalancing" );



project::base_2d_euler_inline::observers::CreateGridAndConvergeLoadBalancing::CreateGridAndConvergeLoadBalancing(int spacetreeId):
...
peano4::grid::TraversalObserver* project::base_2d_euler_inline::observers::CreateGridAndConvergeLoadBalancing::clone(int spacetreeId) {
  return new CreateGridAndConvergeLoadBalancing(spacetreeId);
}

  

std::vector< peano4::grid::GridControlEvent > project::base_2d_euler_inline::observers::CreateGridAndConvergeLoadBalancing::getGridControlEvents() const {
...
void project::base_2d_euler_inline::observers::CreateGridAndConvergeLoadBalancing::beginTraversal( const tarch::la::Vector<Dimensions,double>&  x, const tarch::la::Vector<Dimensions,double>&  h ) {
...
void project::base_2d_euler_inline::observers::CreateGridAndConvergeLoadBalancing::endTraversal( const tarch::la::Vector<Dimensions,double>&  x, const tarch::la::Vector<Dimensions,double>&  h ) {
...
void project::base_2d_euler_inline::observers::CreateGridAndConvergeLoadBalancing::loadCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void project::base_2d_euler_inline::observers::CreateGridAndConvergeLoadBalancing::enterCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void project::base_2d_euler_inline::observers::CreateGridAndConvergeLoadBalancing::leaveCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void project::base_2d_euler_inline::observers::CreateGridAndConvergeLoadBalancing::storeCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void project::base_2d_euler_inline::observers::CreateGridAndConvergeLoadBalancing::exchangeAllVerticalDataExchangeStacks( int masterId ) {
...
void project::base_2d_euler_inline::observers::CreateGridAndConvergeLoadBalancing::exchangeAllHorizontalDataExchangeStacks( bool symmetricDataCardinality ) {
...
void project::base_2d_euler_inline::observers::CreateGridAndConvergeLoadBalancing::exchangeAllPeriodicBoundaryDataStacks() {
...
void project::base_2d_euler_inline::observers::CreateGridAndConvergeLoadBalancing::streamDataFromSplittingTreeToNewTree(int newWorker) {
...
void project::base_2d_euler_inline::observers::CreateGridAndConvergeLoadBalancing::streamDataFromJoiningTreeToMasterTree(int master) {
...
void project::base_2d_euler_inline::observers::CreateGridAndConvergeLoadBalancing::finishAllOutstandingSendsAndReceives() {
...
void project::base_2d_euler_inline::observers::CreateGridAndConvergeLoadBalancing::sendVertex(int position, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::grid::GridTraversalEvent&  event) {
...
void project::base_2d_euler_inline::observers::CreateGridAndConvergeLoadBalancing::sendFace(int position, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::grid::GridTraversalEvent&  event) {
...
void project::base_2d_euler_inline::observers::CreateGridAndConvergeLoadBalancing::sendCell(int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::grid::GridTraversalEvent&  event) {
...
void project::base_2d_euler_inline::observers::CreateGridAndConvergeLoadBalancing::receiveAndMergeCell(int fromStack, SendReceiveContext context, const peano4::grid::GridTraversalEvent& event ) {
...
void project::base_2d_euler_inline::observers::CreateGridAndConvergeLoadBalancing::receiveAndMergeFace(int position, int fromStack, SendReceiveContext context, const peano4::grid::GridTraversalEvent& event) {
...
void project::base_2d_euler_inline::observers::CreateGridAndConvergeLoadBalancing::receiveAndMergeVertex(int position, int fromStack, SendReceiveContext context, const peano4::grid::GridTraversalEvent& event) {
...
void project::base_2d_euler_inline::observers::CreateGridAndConvergeLoadBalancing::deleteAllStacks() {
