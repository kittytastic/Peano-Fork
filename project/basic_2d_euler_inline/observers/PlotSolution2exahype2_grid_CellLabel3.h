#ifndef _PROJECT_BASE_2D_EULER_INLINE_OBSERVERS_PLOTSOLUTION2EXAHYPE2_GRID_CELLLABEL3_H_
#define _PROJECT_BASE_2D_EULER_INLINE_OBSERVERS_PLOTSOLUTION2EXAHYPE2_GRID_CELLLABEL3_H_
...
namespace observers {
  class PlotSolution2exahype2_grid_CellLabel3;
}
}
}
class project::base_2d_euler_inline::observers::PlotSolution2exahype2_grid_CellLabel3{
  private:
  ...
  public:
     ...
     */
    PlotSolution2exahype2_grid_CellLabel3(int treeNumber);

    ~PlotSolution2exahype2_grid_CellLabel3();
