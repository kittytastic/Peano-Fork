#ifndef _PROJECT_BASE_2D_EULER_INLINE_OBSERVERS_CREATEGRID2EXAHYPE2_SOLVERS_FV_ACTIONSETS_INITIALCONDITION0_H_
#define _PROJECT_BASE_2D_EULER_INLINE_OBSERVERS_CREATEGRID2EXAHYPE2_SOLVERS_FV_ACTIONSETS_INITIALCONDITION0_H_
...
namespace observers {
  class CreateGrid2exahype2_solvers_fv_actionsets_InitialCondition0;
}
}
}
class project::base_2d_euler_inline::observers::CreateGrid2exahype2_solvers_fv_actionsets_InitialCondition0{
  private:
  ...
  public:
     ...
     */
    CreateGrid2exahype2_solvers_fv_actionsets_InitialCondition0(int treeNumber);

    ~CreateGrid2exahype2_solvers_fv_actionsets_InitialCondition0();
