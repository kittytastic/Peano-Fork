#ifndef _PROJECT_BASE_2D_EULER_INLINE_OBSERVERS_CREATEGRIDBUTPOSTPONEREFINEMENT2EXAHYPE2_GRID_CELLLABEL2_H_
#define _PROJECT_BASE_2D_EULER_INLINE_OBSERVERS_CREATEGRIDBUTPOSTPONEREFINEMENT2EXAHYPE2_GRID_CELLLABEL2_H_
...
namespace observers {
  class CreateGridButPostponeRefinement2exahype2_grid_CellLabel2;
}
}
}
class project::base_2d_euler_inline::observers::CreateGridButPostponeRefinement2exahype2_grid_CellLabel2{
  private:
  ...
  public:
     ...
     */
    CreateGridButPostponeRefinement2exahype2_grid_CellLabel2(int treeNumber);

    ~CreateGridButPostponeRefinement2exahype2_grid_CellLabel2();
