...
#ifndef _project_base_2d_euler_inline_observers_CreateGrid_H_
#define _project_base_2d_euler_inline_observers_CreateGrid_H_
...
class project::base_2d_euler_inline::observers::CreateGrid: public peano4::grid::TraversalObserver {
  public:
    /**
     * Logging device
     */
