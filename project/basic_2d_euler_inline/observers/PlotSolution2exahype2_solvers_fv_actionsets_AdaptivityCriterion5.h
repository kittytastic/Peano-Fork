#ifndef _PROJECT_BASE_2D_EULER_INLINE_OBSERVERS_PLOTSOLUTION2EXAHYPE2_SOLVERS_FV_ACTIONSETS_ADAPTIVITYCRITERION5_H_
#define _PROJECT_BASE_2D_EULER_INLINE_OBSERVERS_PLOTSOLUTION2EXAHYPE2_SOLVERS_FV_ACTIONSETS_ADAPTIVITYCRITERION5_H_
...
namespace observers {
  class PlotSolution2exahype2_solvers_fv_actionsets_AdaptivityCriterion5;
}
}
}
class project::base_2d_euler_inline::observers::PlotSolution2exahype2_solvers_fv_actionsets_AdaptivityCriterion5{
  private:
  ...
  public:
     ...
     */
    PlotSolution2exahype2_solvers_fv_actionsets_AdaptivityCriterion5(int treeNumber);

    ~PlotSolution2exahype2_solvers_fv_actionsets_AdaptivityCriterion5();
