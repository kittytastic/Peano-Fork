...
tarch::logging::Log project::base_2d_euler_inline::observers::TimeStep::_log( "project::base_2d_euler_inline::observers::TimeStep" );



project::base_2d_euler_inline::observers::TimeStep::TimeStep(int spacetreeId):
...
peano4::grid::TraversalObserver* project::base_2d_euler_inline::observers::TimeStep::clone(int spacetreeId) {
  return new TimeStep(spacetreeId);
}

  

std::vector< peano4::grid::GridControlEvent > project::base_2d_euler_inline::observers::TimeStep::getGridControlEvents() const {
...
void project::base_2d_euler_inline::observers::TimeStep::beginTraversal( const tarch::la::Vector<Dimensions,double>&  x, const tarch::la::Vector<Dimensions,double>&  h ) {
...
void project::base_2d_euler_inline::observers::TimeStep::endTraversal( const tarch::la::Vector<Dimensions,double>&  x, const tarch::la::Vector<Dimensions,double>&  h ) {
...
void project::base_2d_euler_inline::observers::TimeStep::loadCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void project::base_2d_euler_inline::observers::TimeStep::enterCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void project::base_2d_euler_inline::observers::TimeStep::leaveCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void project::base_2d_euler_inline::observers::TimeStep::storeCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void project::base_2d_euler_inline::observers::TimeStep::exchangeAllVerticalDataExchangeStacks( int masterId ) {
...
void project::base_2d_euler_inline::observers::TimeStep::exchangeAllHorizontalDataExchangeStacks( bool symmetricDataCardinality ) {
...
void project::base_2d_euler_inline::observers::TimeStep::exchangeAllPeriodicBoundaryDataStacks() {
...
void project::base_2d_euler_inline::observers::TimeStep::streamDataFromSplittingTreeToNewTree(int newWorker) {
...
void project::base_2d_euler_inline::observers::TimeStep::streamDataFromJoiningTreeToMasterTree(int master) {
...
void project::base_2d_euler_inline::observers::TimeStep::finishAllOutstandingSendsAndReceives() {
...
void project::base_2d_euler_inline::observers::TimeStep::sendVertex(int position, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::grid::GridTraversalEvent&  event) {
...
void project::base_2d_euler_inline::observers::TimeStep::sendFace(int position, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::grid::GridTraversalEvent&  event) {
...
void project::base_2d_euler_inline::observers::TimeStep::sendCell(int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::grid::GridTraversalEvent&  event) {
...
void project::base_2d_euler_inline::observers::TimeStep::receiveAndMergeCell(int fromStack, SendReceiveContext context, const peano4::grid::GridTraversalEvent& event ) {
...
void project::base_2d_euler_inline::observers::TimeStep::receiveAndMergeFace(int position, int fromStack, SendReceiveContext context, const peano4::grid::GridTraversalEvent& event) {
...
void project::base_2d_euler_inline::observers::TimeStep::receiveAndMergeVertex(int position, int fromStack, SendReceiveContext context, const peano4::grid::GridTraversalEvent& event) {
...
void project::base_2d_euler_inline::observers::TimeStep::deleteAllStacks() {
