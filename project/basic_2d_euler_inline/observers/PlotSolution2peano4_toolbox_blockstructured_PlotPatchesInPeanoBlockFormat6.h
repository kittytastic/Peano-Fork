#ifndef _PROJECT_BASE_2D_EULER_INLINE_OBSERVERS_PLOTSOLUTION2PEANO4_TOOLBOX_BLOCKSTRUCTURED_PLOTPATCHESINPEANOBLOCKFORMAT6_H_
#define _PROJECT_BASE_2D_EULER_INLINE_OBSERVERS_PLOTSOLUTION2PEANO4_TOOLBOX_BLOCKSTRUCTURED_PLOTPATCHESINPEANOBLOCKFORMAT6_H_
...
namespace observers {
  class PlotSolution2peano4_toolbox_blockstructured_PlotPatchesInPeanoBlockFormat6;
}
}
}
class project::base_2d_euler_inline::observers::PlotSolution2peano4_toolbox_blockstructured_PlotPatchesInPeanoBlockFormat6{
  private:
  ...
  public:
     ...
     */
    PlotSolution2peano4_toolbox_blockstructured_PlotPatchesInPeanoBlockFormat6(int treeNumber);

    ~PlotSolution2peano4_toolbox_blockstructured_PlotPatchesInPeanoBlockFormat6();
