#ifndef _PROJECT_BASE_2D_EULER_INLINE_OBSERVERS_INITGRID2PEANO4_TOOLBOX_BLOCKSTRUCTURED_BACKUPPATCHOVERLAP1_H_
#define _PROJECT_BASE_2D_EULER_INLINE_OBSERVERS_INITGRID2PEANO4_TOOLBOX_BLOCKSTRUCTURED_BACKUPPATCHOVERLAP1_H_
...
namespace observers {
  class InitGrid2peano4_toolbox_blockstructured_BackupPatchOverlap1;
}
}
}
class project::base_2d_euler_inline::observers::InitGrid2peano4_toolbox_blockstructured_BackupPatchOverlap1{
  private:
  ...
  public:
     ...
     */
    InitGrid2peano4_toolbox_blockstructured_BackupPatchOverlap1(int treeNumber);
