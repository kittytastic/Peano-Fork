...
tarch::logging::Log project::base_2d_euler_inline::observers::PlotSolution::_log( "project::base_2d_euler_inline::observers::PlotSolution" );



project::base_2d_euler_inline::observers::PlotSolution::PlotSolution(int spacetreeId):
...
peano4::grid::TraversalObserver* project::base_2d_euler_inline::observers::PlotSolution::clone(int spacetreeId) {
  return new PlotSolution(spacetreeId);
}

  

std::vector< peano4::grid::GridControlEvent > project::base_2d_euler_inline::observers::PlotSolution::getGridControlEvents() const {
...
void project::base_2d_euler_inline::observers::PlotSolution::beginTraversal( const tarch::la::Vector<Dimensions,double>&  x, const tarch::la::Vector<Dimensions,double>&  h ) {
...
void project::base_2d_euler_inline::observers::PlotSolution::endTraversal( const tarch::la::Vector<Dimensions,double>&  x, const tarch::la::Vector<Dimensions,double>&  h ) {
...
void project::base_2d_euler_inline::observers::PlotSolution::loadCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void project::base_2d_euler_inline::observers::PlotSolution::enterCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void project::base_2d_euler_inline::observers::PlotSolution::leaveCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void project::base_2d_euler_inline::observers::PlotSolution::storeCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void project::base_2d_euler_inline::observers::PlotSolution::exchangeAllVerticalDataExchangeStacks( int masterId ) {
...
void project::base_2d_euler_inline::observers::PlotSolution::exchangeAllHorizontalDataExchangeStacks( bool symmetricDataCardinality ) {
...
void project::base_2d_euler_inline::observers::PlotSolution::exchangeAllPeriodicBoundaryDataStacks() {
...
void project::base_2d_euler_inline::observers::PlotSolution::streamDataFromSplittingTreeToNewTree(int newWorker) {
...
void project::base_2d_euler_inline::observers::PlotSolution::streamDataFromJoiningTreeToMasterTree(int master) {
...
void project::base_2d_euler_inline::observers::PlotSolution::finishAllOutstandingSendsAndReceives() {
...
void project::base_2d_euler_inline::observers::PlotSolution::sendVertex(int position, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::grid::GridTraversalEvent&  event) {
...
void project::base_2d_euler_inline::observers::PlotSolution::sendFace(int position, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::grid::GridTraversalEvent&  event) {
...
void project::base_2d_euler_inline::observers::PlotSolution::sendCell(int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::grid::GridTraversalEvent&  event) {
...
void project::base_2d_euler_inline::observers::PlotSolution::receiveAndMergeCell(int fromStack, SendReceiveContext context, const peano4::grid::GridTraversalEvent& event ) {
...
void project::base_2d_euler_inline::observers::PlotSolution::receiveAndMergeFace(int position, int fromStack, SendReceiveContext context, const peano4::grid::GridTraversalEvent& event) {
...
void project::base_2d_euler_inline::observers::PlotSolution::receiveAndMergeVertex(int position, int fromStack, SendReceiveContext context, const peano4::grid::GridTraversalEvent& event) {
...
void project::base_2d_euler_inline::observers::PlotSolution::deleteAllStacks() {
