#ifndef _PROJECT_BASE_2D_EULER_INLINE_OBSERVERS_PLOTSOLUTION2EXAHYPE2_GRID_FACELABEL2_H_
#define _PROJECT_BASE_2D_EULER_INLINE_OBSERVERS_PLOTSOLUTION2EXAHYPE2_GRID_FACELABEL2_H_
...
namespace observers {
  class PlotSolution2exahype2_grid_FaceLabel2;
}
}
}
class project::base_2d_euler_inline::observers::PlotSolution2exahype2_grid_FaceLabel2{
  private:
  ...
  public:
     ...
     */
    PlotSolution2exahype2_grid_FaceLabel2(int treeNumber);

    ~PlotSolution2exahype2_grid_FaceLabel2();
