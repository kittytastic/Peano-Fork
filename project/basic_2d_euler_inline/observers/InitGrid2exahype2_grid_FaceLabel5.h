#ifndef _PROJECT_BASE_2D_EULER_INLINE_OBSERVERS_INITGRID2EXAHYPE2_GRID_FACELABEL5_H_
#define _PROJECT_BASE_2D_EULER_INLINE_OBSERVERS_INITGRID2EXAHYPE2_GRID_FACELABEL5_H_
...
namespace observers {
  class InitGrid2exahype2_grid_FaceLabel5;
}
}
}
class project::base_2d_euler_inline::observers::InitGrid2exahype2_grid_FaceLabel5{
  private:
  ...
  public:
     ...
     */
    InitGrid2exahype2_grid_FaceLabel5(int treeNumber);
