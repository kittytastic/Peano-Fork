#ifndef _PROJECT_BASE_2D_EULER_INLINE_OBSERVERS_CREATEGRID2EXAHYPE2_GRID_CELLLABEL2_H_
#define _PROJECT_BASE_2D_EULER_INLINE_OBSERVERS_CREATEGRID2EXAHYPE2_GRID_CELLLABEL2_H_
...
namespace observers {
  class CreateGrid2exahype2_grid_CellLabel2;
}
}
}
class project::base_2d_euler_inline::observers::CreateGrid2exahype2_grid_CellLabel2{
  private:
  ...
  public:
     ...
     */
    CreateGrid2exahype2_grid_CellLabel2(int treeNumber);

    ~CreateGrid2exahype2_grid_CellLabel2();
