#ifndef _PROJECT_BASE_2D_EULER_INLINE_OBSERVERS_TIMESTEP2EXAHYPE2_SOLVERS_FV_ACTIONSETS_HANDLEBOUNDARY4_H_
#define _PROJECT_BASE_2D_EULER_INLINE_OBSERVERS_TIMESTEP2EXAHYPE2_SOLVERS_FV_ACTIONSETS_HANDLEBOUNDARY4_H_
...
namespace observers {
  class TimeStep2exahype2_solvers_fv_actionsets_HandleBoundary4;
}
}
}
class project::base_2d_euler_inline::observers::TimeStep2exahype2_solvers_fv_actionsets_HandleBoundary4{
  private:
  ...
  public:
     ...
     */
    TimeStep2exahype2_solvers_fv_actionsets_HandleBoundary4(int treeNumber);

    ~TimeStep2exahype2_solvers_fv_actionsets_HandleBoundary4();
