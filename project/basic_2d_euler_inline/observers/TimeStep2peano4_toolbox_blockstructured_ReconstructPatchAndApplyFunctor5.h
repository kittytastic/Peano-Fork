#ifndef _PROJECT_BASE_2D_EULER_INLINE_OBSERVERS_TIMESTEP2PEANO4_TOOLBOX_BLOCKSTRUCTURED_RECONSTRUCTPATCHANDAPPLYFUNCTOR5_H_
#define _PROJECT_BASE_2D_EULER_INLINE_OBSERVERS_TIMESTEP2PEANO4_TOOLBOX_BLOCKSTRUCTURED_RECONSTRUCTPATCHANDAPPLYFUNCTOR5_H_
...
namespace observers {
  class TimeStep2peano4_toolbox_blockstructured_ReconstructPatchAndApplyFunctor5;
}
}
}
class project::base_2d_euler_inline::observers::TimeStep2peano4_toolbox_blockstructured_ReconstructPatchAndApplyFunctor5{
  private:
...
int  _treeNumber;
  public:
     ...
     */
    TimeStep2peano4_toolbox_blockstructured_ReconstructPatchAndApplyFunctor5(int treeNumber);

    ~TimeStep2peano4_toolbox_blockstructured_ReconstructPatchAndApplyFunctor5();
