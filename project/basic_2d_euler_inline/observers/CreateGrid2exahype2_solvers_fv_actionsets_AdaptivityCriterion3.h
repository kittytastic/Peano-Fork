#ifndef _PROJECT_BASE_2D_EULER_INLINE_OBSERVERS_CREATEGRID2EXAHYPE2_SOLVERS_FV_ACTIONSETS_ADAPTIVITYCRITERION3_H_
#define _PROJECT_BASE_2D_EULER_INLINE_OBSERVERS_CREATEGRID2EXAHYPE2_SOLVERS_FV_ACTIONSETS_ADAPTIVITYCRITERION3_H_
...
namespace observers {
  class CreateGrid2exahype2_solvers_fv_actionsets_AdaptivityCriterion3;
}
}
}
class project::base_2d_euler_inline::observers::CreateGrid2exahype2_solvers_fv_actionsets_AdaptivityCriterion3{
  private:
  ...
  public:
     ...
     */
    CreateGrid2exahype2_solvers_fv_actionsets_AdaptivityCriterion3(int treeNumber);
