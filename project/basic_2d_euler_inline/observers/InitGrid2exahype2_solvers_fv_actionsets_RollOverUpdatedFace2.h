#ifndef _PROJECT_BASE_2D_EULER_INLINE_OBSERVERS_INITGRID2EXAHYPE2_SOLVERS_FV_ACTIONSETS_ROLLOVERUPDATEDFACE2_H_
#define _PROJECT_BASE_2D_EULER_INLINE_OBSERVERS_INITGRID2EXAHYPE2_SOLVERS_FV_ACTIONSETS_ROLLOVERUPDATEDFACE2_H_
...
namespace observers {
  class InitGrid2exahype2_solvers_fv_actionsets_RollOverUpdatedFace2;
}
}
}
class project::base_2d_euler_inline::observers::InitGrid2exahype2_solvers_fv_actionsets_RollOverUpdatedFace2{
  private:
  ...
  public:
     ...
     */
    InitGrid2exahype2_solvers_fv_actionsets_RollOverUpdatedFace2(int treeNumber);

    ~InitGrid2exahype2_solvers_fv_actionsets_RollOverUpdatedFace2();
