...
// here
//  
#ifndef _INCLUDE_PROJECT_BASE_2D_EULER_INLINE_CELLDATA_EULER2DCELLLABEL_
#define _INCLUDE_PROJECT_BASE_2D_EULER_INLINE_CELLDATA_EULER2DCELLLABEL_
...
struct project::base_2d_euler_inline::celldata::euler2DCellLabel {
  public:
     ...
     * blocking MPI_Send. 
     */
    static void send(const project::base_2d_euler_inline::celldata::euler2DCellLabel& buffer, int destination, int tag, MPI_Comm communicator );
    static void receive(project::base_2d_euler_inline::celldata::euler2DCellLabel& buffer, int source, int tag, MPI_Comm communicator );
     ...
     */
    static void send(const project::base_2d_euler_inline::celldata::euler2DCellLabel& buffer, int destination, int tag, std::function<void()> waitFunctor, MPI_Comm communicator );
    static void receive(project::base_2d_euler_inline::celldata::euler2DCellLabel& buffer, int source, int tag, std::function<void()> waitFunctor, MPI_Comm communicator );
    #endif


#ifdef Parallel
    static void sendAndPollDanglingMessages(const project::base_2d_euler_inline::celldata::euler2DCellLabel& message, int destination, int tag, MPI_Comm communicator=tarch::mpi::Rank::getInstance().getCommunicator());
    static void receiveAndPollDanglingMessages(project::base_2d_euler_inline::celldata::euler2DCellLabel& message, int source, int tag, MPI_Comm communicator=tarch::mpi::Rank::getInstance().getCommunicator() );
#endif
    
    void merge(const project::base_2d_euler_inline::celldata::euler2DCellLabel& neighbour, const peano4::datamanagement::CellMarker& marker);
