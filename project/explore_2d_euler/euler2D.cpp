...
tarch::logging::Log   project::explore_2d_euler::euler2D::_log( "project::explore_2d_euler::euler2D" );
...
void project::explore_2d_euler::euler2D::initialCondition(
...
void project::explore_2d_euler::euler2D::boundaryConditions(
...
double ::project::explore_2d_euler::euler2D::maxEigenvalue(
...
void ::project::explore_2d_euler::euler2D::flux(
  const double * __restrict__ Q, // Q[4+0],
  const tarch::la::Vector<Dimensions,double>&  faceCentre,
  const tarch::la::Vector<Dimensions,double>&  volumeH,
  double                                       t,
