...
#ifndef _project_base_2d_euler_observers_CreateGridButPostponeRefinement_H_
#define _project_base_2d_euler_observers_CreateGridButPostponeRefinement_H_
...
#include "observers/CreateGridButPostponeRefinement2exahype2_solvers_fv_actionsets_InitialCondition0.h"
#include "observers/CreateGridButPostponeRefinement2exahype2_grid_FaceLabel1.h"
#include "observers/CreateGridButPostponeRefinement2exahype2_grid_CellLabel2.h"
#include "observers/CreateGridButPostponeRefinement2exahype2_solvers_fv_actionsets_AdaptivityCriterion3.h"
...
class project::base_2d_euler::observers::CreateGridButPostponeRefinement: public peano4::grid::TraversalObserver {
  public:
    /**
     * Logging device
     */
    ...
    observers::CreateGridButPostponeRefinement2exahype2_solvers_fv_actionsets_InitialCondition0   _actionSet0; 
    observers::CreateGridButPostponeRefinement2exahype2_grid_FaceLabel1   _actionSet1; 
    observers::CreateGridButPostponeRefinement2exahype2_grid_CellLabel2   _actionSet2; 
    observers::CreateGridButPostponeRefinement2exahype2_solvers_fv_actionsets_AdaptivityCriterion3   _actionSet3; 
  ...
  public:
     ...
     */
    CreateGridButPostponeRefinement(int spacetreeId = SpacetreePrototype);
