...
#include "CreateGridAndConvergeLoadBalancing.h"
...
tarch::logging::Log project::base_2d_euler::observers::CreateGridAndConvergeLoadBalancing::_log( "project::base_2d_euler::observers::CreateGridAndConvergeLoadBalancing" );



project::base_2d_euler::observers::CreateGridAndConvergeLoadBalancing::CreateGridAndConvergeLoadBalancing(int spacetreeId):
  _spacetreeId( spacetreeId ) , _actionSet0(spacetreeId), _actionSet1(spacetreeId), _actionSet2(spacetreeId), _actionSet3(spacetreeId)
{
}
...
peano4::grid::TraversalObserver* project::base_2d_euler::observers::CreateGridAndConvergeLoadBalancing::clone(int spacetreeId) {
  return new CreateGridAndConvergeLoadBalancing(spacetreeId);
}

  

std::vector< peano4::grid::GridControlEvent > project::base_2d_euler::observers::CreateGridAndConvergeLoadBalancing::getGridControlEvents() const {
...
void project::base_2d_euler::observers::CreateGridAndConvergeLoadBalancing::beginTraversal( const tarch::la::Vector<Dimensions,double>&  x, const tarch::la::Vector<Dimensions,double>&  h ) {
  ...
  //
  repositories::DataRepository::_CellDataeuler2DQStack.getForPush( repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack))->push( project::base_2d_euler::celldata::euler2DQ() );
  repositories::DataRepository::_CellDataeuler2DCellLabelStack.getForPush( repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack))->push( project::base_2d_euler::celldata::euler2DCellLabel() );
  for (int i=0; i<TwoTimesD; i++) {
    repositories::DataRepository::_FaceDataeuler2DQOldStack.getForPush( repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack))->push( project::base_2d_euler::facedata::euler2DQOld() );
  }
  for (int i=0; i<TwoTimesD; i++) {
    repositories::DataRepository::_FaceDataeuler2DQNewStack.getForPush( repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack))->push( project::base_2d_euler::facedata::euler2DQNew() );
  }
  for (int i=0; i<TwoTimesD; i++) {
    repositories::DataRepository::_FaceDataeuler2DQUpdateStack.getForPush( repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack))->push( project::base_2d_euler::facedata::euler2DQUpdate() );
  }
  for (int i=0; i<TwoTimesD; i++) {
    repositories::DataRepository::_FaceDataeuler2DFaceLabelStack.getForPush( repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack))->push( project::base_2d_euler::facedata::euler2DFaceLabel() );
  }
...
void project::base_2d_euler::observers::CreateGridAndConvergeLoadBalancing::endTraversal( const tarch::la::Vector<Dimensions,double>&  x, const tarch::la::Vector<Dimensions,double>&  h ) {
...
void project::base_2d_euler::observers::CreateGridAndConvergeLoadBalancing::loadCell( const peano4::grid::GridTraversalEvent&  event ) {
  ...
  // Load face euler2DQOld
  {
    ...
    for (int i=0; i<TwoTimesD; i++) {
      ...
      project::base_2d_euler::facedata::euler2DQOld data ;
      if (
        ...
        and
        (not peano4::grid::PeanoCurve::isInOutStack(inFaceStack) or project::base_2d_euler::facedata::euler2DQOld::loadPersistently(marker))
      ) {
      ...
      if (
        ...
        inFaceStack==peano4::grid::TraversalObserver::NoData
        or
        not project::base_2d_euler::facedata::euler2DQOld::loadPersistently(marker)
      ) {
        logDebug( "loadCell(...)", "initialise meta data of face euler2DQOld with " << marker.x(outFaceStackPosition) << " x " << marker.h() << ": load persistent data=" << project::base_2d_euler::facedata::euler2DQOld::loadPersistently(marker)  << " (" << marker.toString() << ")" );
  ...
  // Load face euler2DQNew
  {
    ...
    for (int i=0; i<TwoTimesD; i++) {
      ...
      project::base_2d_euler::facedata::euler2DQNew data ;
      if (
        inFaceStack!=peano4::grid::TraversalObserver::CreateOrDestroyPersistentGridEntity
        and
        inFaceStack!=peano4::grid::TraversalObserver::CreateOrDestroyHangingGridEntity
        ...
        inFaceStack!=peano4::grid::TraversalObserver::NoData
        and
        (not peano4::grid::PeanoCurve::isInOutStack(inFaceStack) or project::base_2d_euler::facedata::euler2DQNew::loadPersistently(marker))
      ) {
      ...
      if (
        ...
        inFaceStack==peano4::grid::TraversalObserver::NoData
        or
        not project::base_2d_euler::facedata::euler2DQNew::loadPersistently(marker)
      ) {
        logDebug( "loadCell(...)", "initialise meta data of face euler2DQNew with " << marker.x(outFaceStackPosition) << " x " << marker.h() << ": load persistent data=" << project::base_2d_euler::facedata::euler2DQNew::loadPersistently(marker)  << " (" << marker.toString() << ")" );
        data.setDebugX( marker.x(outFaceStackPosition) );
        data.setDebugH( marker.h() );
      }
      else if (
  ...
  // Load face euler2DQUpdate
  {
    ...
    for (int i=0; i<TwoTimesD; i++) {
      ...
      project::base_2d_euler::facedata::euler2DQUpdate data ;
      if (
        inFaceStack!=peano4::grid::TraversalObserver::CreateOrDestroyPersistentGridEntity
        and
        inFaceStack!=peano4::grid::TraversalObserver::CreateOrDestroyHangingGridEntity
        ...
        inFaceStack!=peano4::grid::TraversalObserver::NoData
        and
        (not peano4::grid::PeanoCurve::isInOutStack(inFaceStack) or project::base_2d_euler::facedata::euler2DQUpdate::loadPersistently(marker))
      ) {
      ...
      if (
        ...
        inFaceStack==peano4::grid::TraversalObserver::NoData
        or
        not project::base_2d_euler::facedata::euler2DQUpdate::loadPersistently(marker)
      ) {
        logDebug( "loadCell(...)", "initialise meta data of face euler2DQUpdate with " << marker.x(outFaceStackPosition) << " x " << marker.h() << ": load persistent data=" << project::base_2d_euler::facedata::euler2DQUpdate::loadPersistently(marker)  << " (" << marker.toString() << ")" );
        data.setDebugX( marker.x(outFaceStackPosition) );
        data.setDebugH( marker.h() );
      }
      else if (
  ...
  // Load face euler2DFaceLabel
  {
    ...
    for (int i=0; i<TwoTimesD; i++) {
      ...
      project::base_2d_euler::facedata::euler2DFaceLabel data ;
      if (
        inFaceStack!=peano4::grid::TraversalObserver::CreateOrDestroyPersistentGridEntity
        and
        inFaceStack!=peano4::grid::TraversalObserver::CreateOrDestroyHangingGridEntity
        ...
        inFaceStack!=peano4::grid::TraversalObserver::NoData
        and
        (not peano4::grid::PeanoCurve::isInOutStack(inFaceStack) or project::base_2d_euler::facedata::euler2DFaceLabel::loadPersistently(marker))
      ) {
      ...
      if (
        ...
        inFaceStack==peano4::grid::TraversalObserver::NoData
        or
        not project::base_2d_euler::facedata::euler2DFaceLabel::loadPersistently(marker)
      ) {
        logDebug( "loadCell(...)", "initialise meta data of face euler2DFaceLabel with " << marker.x(outFaceStackPosition) << " x " << marker.h() << ": load persistent data=" << project::base_2d_euler::facedata::euler2DFaceLabel::loadPersistently(marker)  << " (" << marker.toString() << ")" );
        data.setDebugX( marker.x(outFaceStackPosition) );
        data.setDebugH( marker.h() );
      }
      else if (
  ...
  // Load cell euler2DQ
  {
    ...
    logDebug("loadCell(...)", "cell stack " << inCellStack << "->pos-" << outCellStack << "(" << project::base_2d_euler::celldata::euler2DQ::loadPersistently(marker) << ")" );

    project::base_2d_euler::celldata::euler2DQ& data = view.get(0);
    if (
      ...
      and
      (not peano4::grid::PeanoCurve::isInOutStack(inCellStack) or project::base_2d_euler::celldata::euler2DQ::loadPersistently(marker))
    ) {
    ...
    if (
      ...
      inCellStack==peano4::grid::TraversalObserver::NoData
      or
      not project::base_2d_euler::celldata::euler2DQ::loadPersistently(marker)
    ) {
  ...
  // Load cell euler2DCellLabel
  {
    ...
    const int inCellStack  = event.getCellData();
    const int outCellStack = peano4::grid::PeanoCurve::CallStack;
    logDebug("loadCell(...)", "cell stack " << inCellStack << "->pos-" << outCellStack << "(" << project::base_2d_euler::celldata::euler2DCellLabel::loadPersistently(marker) << ")" );

    project::base_2d_euler::celldata::euler2DCellLabel& data = view.get(0);
    if (
      inCellStack!=peano4::grid::TraversalObserver::CreateOrDestroyPersistentGridEntity
      and
      inCellStack!=peano4::grid::TraversalObserver::NoData
      and
      (not peano4::grid::PeanoCurve::isInOutStack(inCellStack) or project::base_2d_euler::celldata::euler2DCellLabel::loadPersistently(marker))
    ) {
    ...
    if (
      ...
      inCellStack==peano4::grid::TraversalObserver::NoData
      or
      not project::base_2d_euler::celldata::euler2DCellLabel::loadPersistently(marker)
    ) {
...
void project::base_2d_euler::observers::CreateGridAndConvergeLoadBalancing::enterCell( const peano4::grid::GridTraversalEvent&  event ) {
    ...
    for (int i=0; i<TwoTimesD; i++) {
      ...
      if (
        ...
        _actionSet0.createPersistentFace(
          ...
          ,peano4::datamanagement::FaceEnumerator<project::base_2d_euler::facedata::euler2DQOld>( &repositories::DataRepository::_FaceDataeuler2DQOldStack.getForPop( repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack))->top(TwoTimesD-1) )(pick),peano4::datamanagement::FaceEnumerator<project::base_2d_euler::facedata::euler2DQNew>( &repositories::DataRepository::_FaceDataeuler2DQNewStack.getForPop( repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack))->top(TwoTimesD-1) )(pick),peano4::datamanagement::FaceEnumerator<project::base_2d_euler::facedata::euler2DQUpdate>( &repositories::DataRepository::_FaceDataeuler2DQUpdateStack.getForPop( repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack))->top(TwoTimesD-1) )(pick),peano4::datamanagement::FaceEnumerator<project::base_2d_euler::facedata::euler2DFaceLabel>( &repositories::DataRepository::_FaceDataeuler2DFaceLabelStack.getForPop( repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack))->top(TwoTimesD-1) )(pick)
          ,peano4::datamanagement::FaceEnumerator<project::base_2d_euler::facedata::euler2DQOld>( &repositories::DataRepository::_FaceDataeuler2DQOldStack.getForPop( repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack))->top(TwoTimesD*2-1) ),peano4::datamanagement::FaceEnumerator<project::base_2d_euler::facedata::euler2DQNew>( &repositories::DataRepository::_FaceDataeuler2DQNewStack.getForPop( repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack))->top(TwoTimesD*2-1) ),peano4::datamanagement::FaceEnumerator<project::base_2d_euler::facedata::euler2DQUpdate>( &repositories::DataRepository::_FaceDataeuler2DQUpdateStack.getForPop( repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack))->top(TwoTimesD*2-1) ),peano4::datamanagement::FaceEnumerator<project::base_2d_euler::facedata::euler2DFaceLabel>( &repositories::DataRepository::_FaceDataeuler2DFaceLabelStack.getForPop( repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack))->top(TwoTimesD*2-1) ),repositories::DataRepository::_CellDataeuler2DQStack.getForPop( repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack))->top(1),repositories::DataRepository::_CellDataeuler2DCellLabelStack.getForPop( repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack))->top(1)
        );
  ...
  // Invoke creational events on cell euler2DCellLabel
  {
    ...
    if (
      ...
      _actionSet0.createCell(
        ...
        peano4::datamanagement::FaceEnumerator<project::base_2d_euler::facedata::euler2DQOld>( &repositories::DataRepository::_FaceDataeuler2DQOldStack.getForPop( repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack))->top(TwoTimesD-1) ),peano4::datamanagement::FaceEnumerator<project::base_2d_euler::facedata::euler2DQNew>( &repositories::DataRepository::_FaceDataeuler2DQNewStack.getForPop( repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack))->top(TwoTimesD-1) ),peano4::datamanagement::FaceEnumerator<project::base_2d_euler::facedata::euler2DQUpdate>( &repositories::DataRepository::_FaceDataeuler2DQUpdateStack.getForPop( repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack))->top(TwoTimesD-1) ),peano4::datamanagement::FaceEnumerator<project::base_2d_euler::facedata::euler2DFaceLabel>( &repositories::DataRepository::_FaceDataeuler2DFaceLabelStack.getForPop( repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack))->top(TwoTimesD-1) ),
...
void project::base_2d_euler::observers::CreateGridAndConvergeLoadBalancing::leaveCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void project::base_2d_euler::observers::CreateGridAndConvergeLoadBalancing::storeCell( const peano4::grid::GridTraversalEvent&  event ) {
  ...
  // Handle cell euler2DQ
  {
    ...
    if (
      ...
      and
      (not peano4::grid::PeanoCurve::isInOutStack(outCellStack) or project::base_2d_euler::celldata::euler2DQ::storePersistently(marker))
    ) {
      ...
      logDebug( 
        ...
        ", store-persistently=" << project::base_2d_euler::celldata::euler2DQ::storePersistently(marker)
      );
    }
  }
  ...
  // Handle cell euler2DCellLabel
  {
    ...
    if (
      ...
      outCellStack!=peano4::grid::TraversalObserver::NoData
      and
      (not peano4::grid::PeanoCurve::isInOutStack(outCellStack) or project::base_2d_euler::celldata::euler2DCellLabel::storePersistently(marker))
    ) {
      ...
      logDebug( 
        ...
        ", no-data=" << (outCellStack==peano4::grid::TraversalObserver::NoData) <<
        ", is-in/out=" << peano4::grid::PeanoCurve::isInOutStack(outCellStack) <<
        ", store-persistently=" << project::base_2d_euler::celldata::euler2DCellLabel::storePersistently(marker)
      );
    }
  }
  ...
  // Store face euler2DQOld
  {
    ...
    for (int i=0; i<TwoTimesD; i++) {
      ...
      project::base_2d_euler::facedata::euler2DQOld data = view.get(inFaceStackPosition);
      ...
      if (
        ...
        and
        (not peano4::grid::PeanoCurve::isInOutStack(outFaceStack) or project::base_2d_euler::facedata::euler2DQOld::storePersistently(marker))
      ) {
        ...
        logDebug( "storeCell(...)", "do not store face euler2DQOld with " << marker.x(inFaceStackPosition) << " x " << marker.h() << ": store persistently=" << project::base_2d_euler::facedata::euler2DQOld::storePersistently(marker) );
      }
    }
  }
  ...
  // Store face euler2DQNew
  {
    ...
    for (int i=0; i<TwoTimesD; i++) {
      ...
      project::base_2d_euler::facedata::euler2DQNew data = view.get(inFaceStackPosition);
      ...
      if (
        ...
        outFaceStack!=peano4::grid::TraversalObserver::NoData
        and
        (not peano4::grid::PeanoCurve::isInOutStack(outFaceStack) or project::base_2d_euler::facedata::euler2DQNew::storePersistently(marker))
      ) {
        ...
        logDebug( "storeCell(...)", "do not store face euler2DQNew with " << marker.x(inFaceStackPosition) << " x " << marker.h() << ": store persistently=" << project::base_2d_euler::facedata::euler2DQNew::storePersistently(marker) );
      }
    }
  }
  ...
  // Store face euler2DQUpdate
  {
    ...
    for (int i=0; i<TwoTimesD; i++) {
      ...
      project::base_2d_euler::facedata::euler2DQUpdate data = view.get(inFaceStackPosition);
      ...
      if (
        ...
        outFaceStack!=peano4::grid::TraversalObserver::NoData
        and
        (not peano4::grid::PeanoCurve::isInOutStack(outFaceStack) or project::base_2d_euler::facedata::euler2DQUpdate::storePersistently(marker))
      ) {
        ...
        logDebug( "storeCell(...)", "do not store face euler2DQUpdate with " << marker.x(inFaceStackPosition) << " x " << marker.h() << ": store persistently=" << project::base_2d_euler::facedata::euler2DQUpdate::storePersistently(marker) );
      }
    }
  }
  ...
  // Store face euler2DFaceLabel
  {
    ...
    for (int i=0; i<TwoTimesD; i++) {
      ...
      project::base_2d_euler::facedata::euler2DFaceLabel data = view.get(inFaceStackPosition);
      ...
      if (
        ...
        outFaceStack!=peano4::grid::TraversalObserver::NoData
        and
        (not peano4::grid::PeanoCurve::isInOutStack(outFaceStack) or project::base_2d_euler::facedata::euler2DFaceLabel::storePersistently(marker))
      ) {
        ...
        logDebug( "storeCell(...)", "do not store face euler2DFaceLabel with " << marker.x(inFaceStackPosition) << " x " << marker.h() << ": store persistently=" << project::base_2d_euler::facedata::euler2DFaceLabel::storePersistently(marker) );
      }
    }
  }
...
void project::base_2d_euler::observers::CreateGridAndConvergeLoadBalancing::exchangeAllVerticalDataExchangeStacks( int masterId ) {
...
void project::base_2d_euler::observers::CreateGridAndConvergeLoadBalancing::exchangeAllHorizontalDataExchangeStacks( bool symmetricDataCardinality ) {
...
void project::base_2d_euler::observers::CreateGridAndConvergeLoadBalancing::exchangeAllPeriodicBoundaryDataStacks() {
...
void project::base_2d_euler::observers::CreateGridAndConvergeLoadBalancing::streamDataFromSplittingTreeToNewTree(int newWorker) {
...
void project::base_2d_euler::observers::CreateGridAndConvergeLoadBalancing::streamDataFromJoiningTreeToMasterTree(int master) {
...
void project::base_2d_euler::observers::CreateGridAndConvergeLoadBalancing::finishAllOutstandingSendsAndReceives() {
...
void project::base_2d_euler::observers::CreateGridAndConvergeLoadBalancing::sendVertex(int position, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::grid::GridTraversalEvent&  event) {
...
void project::base_2d_euler::observers::CreateGridAndConvergeLoadBalancing::sendFace(int position, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::grid::GridTraversalEvent&  event) {
...

  {
    ...
    if (
      project::base_2d_euler::facedata::euler2DQOld::storePersistently(marker) 
      and
      (context==::peano4::grid::TraversalObserver::SendReceiveContext::Rebalancing or project::base_2d_euler::facedata::euler2DQOld::send(marker))
     ) {
      project::base_2d_euler::facedata::euler2DQOld data = repositories::DataRepository::_FaceDataeuler2DQOldStack.getForPop( 
...

  {
    peano4::datamanagement::FaceMarker  marker(event,position);
    if (
      project::base_2d_euler::facedata::euler2DQNew::storePersistently(marker) 
      and
      (context==::peano4::grid::TraversalObserver::SendReceiveContext::Rebalancing or project::base_2d_euler::facedata::euler2DQNew::send(marker))
     ) {
      project::base_2d_euler::facedata::euler2DQNew data = repositories::DataRepository::_FaceDataeuler2DQNewStack.getForPop( 
        repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack)
      )->top(TwoTimesD-1-position);
...

  {
    peano4::datamanagement::FaceMarker  marker(event,position);
    if (
      project::base_2d_euler::facedata::euler2DQUpdate::storePersistently(marker) 
      and
      (context==::peano4::grid::TraversalObserver::SendReceiveContext::Rebalancing or project::base_2d_euler::facedata::euler2DQUpdate::send(marker))
     ) {
      project::base_2d_euler::facedata::euler2DQUpdate data = repositories::DataRepository::_FaceDataeuler2DQUpdateStack.getForPop( 
        repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack)
      )->top(TwoTimesD-1-position);
...

  {
    peano4::datamanagement::FaceMarker  marker(event,position);
    if (
      project::base_2d_euler::facedata::euler2DFaceLabel::storePersistently(marker) 
      and
      (context==::peano4::grid::TraversalObserver::SendReceiveContext::Rebalancing or project::base_2d_euler::facedata::euler2DFaceLabel::send(marker))
     ) {
      project::base_2d_euler::facedata::euler2DFaceLabel data = repositories::DataRepository::_FaceDataeuler2DFaceLabelStack.getForPop( 
        repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack)
      )->top(TwoTimesD-1-position);
...
void project::base_2d_euler::observers::CreateGridAndConvergeLoadBalancing::sendCell(int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::grid::GridTraversalEvent&  event) {
...

  {
    peano4::datamanagement::CellMarker  marker(event);
    if (
      project::base_2d_euler::celldata::euler2DQ::storePersistently(marker) 
      and
      (context==::peano4::grid::TraversalObserver::SendReceiveContext::Rebalancing or project::base_2d_euler::celldata::euler2DQ::send(marker))
     ) {
      project::base_2d_euler::celldata::euler2DQ data = repositories::DataRepository::_CellDataeuler2DQStack.getForPop( repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack))->top();
...

  {
    peano4::datamanagement::CellMarker  marker(event);
    if (
      project::base_2d_euler::celldata::euler2DCellLabel::storePersistently(marker) 
      and
      (context==::peano4::grid::TraversalObserver::SendReceiveContext::Rebalancing or project::base_2d_euler::celldata::euler2DCellLabel::send(marker))
     ) {
      project::base_2d_euler::celldata::euler2DCellLabel data = repositories::DataRepository::_CellDataeuler2DCellLabelStack.getForPop( repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack))->top();
...
void project::base_2d_euler::observers::CreateGridAndConvergeLoadBalancing::receiveAndMergeCell(int fromStack, SendReceiveContext context, const peano4::grid::GridTraversalEvent& event ) {
...

  {
    ...
    if ( 
      project::base_2d_euler::celldata::euler2DQ::loadPersistently(marker) 
      and
      (context==::peano4::grid::TraversalObserver::SendReceiveContext::Rebalancing or project::base_2d_euler::celldata::euler2DQ::receiveAndMerge(marker))
     ) {
      auto   incomingData = repositories::DataRepository::_CellDataeuler2DQStack.getForPop(
        _spacetreeId, fromStack
      )->pop();

      project::base_2d_euler::celldata::euler2DQ& data = repositories::DataRepository::_CellDataeuler2DQStack.getForPush( 
        repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack)
      )->top();
...

  {
    ...
    if ( 
      project::base_2d_euler::celldata::euler2DCellLabel::loadPersistently(marker) 
      and
      (context==::peano4::grid::TraversalObserver::SendReceiveContext::Rebalancing or project::base_2d_euler::celldata::euler2DCellLabel::receiveAndMerge(marker))
     ) {
      auto   incomingData = repositories::DataRepository::_CellDataeuler2DCellLabelStack.getForPop(
        _spacetreeId, fromStack
      )->pop();

      project::base_2d_euler::celldata::euler2DCellLabel& data = repositories::DataRepository::_CellDataeuler2DCellLabelStack.getForPush( 
        repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack)
      )->top();
...
void project::base_2d_euler::observers::CreateGridAndConvergeLoadBalancing::receiveAndMergeFace(int position, int fromStack, SendReceiveContext context, const peano4::grid::GridTraversalEvent& event) {
...

  {
    ...
    if ( 
      project::base_2d_euler::facedata::euler2DQOld::loadPersistently(marker) 
      and
      (context==::peano4::grid::TraversalObserver::SendReceiveContext::Rebalancing or project::base_2d_euler::facedata::euler2DQOld::receiveAndMerge(marker))
     ) {
      auto   incomingData = repositories::DataRepository::_FaceDataeuler2DQOldStack.getForPop(
        _spacetreeId, fromStack
      )->pop();

      project::base_2d_euler::facedata::euler2DQOld& data = repositories::DataRepository::_FaceDataeuler2DQOldStack.getForPush( 
        repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack)
      )->top(TwoTimesD-1-position);
...

  {
    ...
    if ( 
      project::base_2d_euler::facedata::euler2DQNew::loadPersistently(marker) 
      and
      (context==::peano4::grid::TraversalObserver::SendReceiveContext::Rebalancing or project::base_2d_euler::facedata::euler2DQNew::receiveAndMerge(marker))
     ) {
      auto   incomingData = repositories::DataRepository::_FaceDataeuler2DQNewStack.getForPop(
        _spacetreeId, fromStack
      )->pop();

      project::base_2d_euler::facedata::euler2DQNew& data = repositories::DataRepository::_FaceDataeuler2DQNewStack.getForPush( 
        repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack)
      )->top(TwoTimesD-1-position);
...

  {
    ...
    if ( 
      project::base_2d_euler::facedata::euler2DQUpdate::loadPersistently(marker) 
      and
      (context==::peano4::grid::TraversalObserver::SendReceiveContext::Rebalancing or project::base_2d_euler::facedata::euler2DQUpdate::receiveAndMerge(marker))
     ) {
      auto   incomingData = repositories::DataRepository::_FaceDataeuler2DQUpdateStack.getForPop(
        _spacetreeId, fromStack
      )->pop();

      project::base_2d_euler::facedata::euler2DQUpdate& data = repositories::DataRepository::_FaceDataeuler2DQUpdateStack.getForPush( 
        repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack)
      )->top(TwoTimesD-1-position);
...

  {
    ...
    if ( 
      project::base_2d_euler::facedata::euler2DFaceLabel::loadPersistently(marker) 
      and
      (context==::peano4::grid::TraversalObserver::SendReceiveContext::Rebalancing or project::base_2d_euler::facedata::euler2DFaceLabel::receiveAndMerge(marker))
     ) {
      auto   incomingData = repositories::DataRepository::_FaceDataeuler2DFaceLabelStack.getForPop(
        _spacetreeId, fromStack
      )->pop();

      project::base_2d_euler::facedata::euler2DFaceLabel& data = repositories::DataRepository::_FaceDataeuler2DFaceLabelStack.getForPush( 
        repositories::DataRepository::DataKey(_spacetreeId,peano4::grid::PeanoCurve::CallStack)
      )->top(TwoTimesD-1-position);
...
void project::base_2d_euler::observers::CreateGridAndConvergeLoadBalancing::receiveAndMergeVertex(int position, int fromStack, SendReceiveContext context, const peano4::grid::GridTraversalEvent& event) {
...
void project::base_2d_euler::observers::CreateGridAndConvergeLoadBalancing::deleteAllStacks() {
