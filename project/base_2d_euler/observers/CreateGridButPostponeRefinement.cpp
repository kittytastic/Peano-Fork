...
#include "CreateGridButPostponeRefinement.h"
...
tarch::logging::Log project::base_2d_euler::observers::CreateGridButPostponeRefinement::_log( "project::base_2d_euler::observers::CreateGridButPostponeRefinement" );



project::base_2d_euler::observers::CreateGridButPostponeRefinement::CreateGridButPostponeRefinement(int spacetreeId):
...
peano4::grid::TraversalObserver* project::base_2d_euler::observers::CreateGridButPostponeRefinement::clone(int spacetreeId) {
  return new CreateGridButPostponeRefinement(spacetreeId);
}

  

std::vector< peano4::grid::GridControlEvent > project::base_2d_euler::observers::CreateGridButPostponeRefinement::getGridControlEvents() const {
...
void project::base_2d_euler::observers::CreateGridButPostponeRefinement::beginTraversal( const tarch::la::Vector<Dimensions,double>&  x, const tarch::la::Vector<Dimensions,double>&  h ) {
...
void project::base_2d_euler::observers::CreateGridButPostponeRefinement::endTraversal( const tarch::la::Vector<Dimensions,double>&  x, const tarch::la::Vector<Dimensions,double>&  h ) {
...
void project::base_2d_euler::observers::CreateGridButPostponeRefinement::loadCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void project::base_2d_euler::observers::CreateGridButPostponeRefinement::enterCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void project::base_2d_euler::observers::CreateGridButPostponeRefinement::leaveCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void project::base_2d_euler::observers::CreateGridButPostponeRefinement::storeCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void project::base_2d_euler::observers::CreateGridButPostponeRefinement::exchangeAllVerticalDataExchangeStacks( int masterId ) {
...
void project::base_2d_euler::observers::CreateGridButPostponeRefinement::exchangeAllHorizontalDataExchangeStacks( bool symmetricDataCardinality ) {
...
void project::base_2d_euler::observers::CreateGridButPostponeRefinement::exchangeAllPeriodicBoundaryDataStacks() {
...
void project::base_2d_euler::observers::CreateGridButPostponeRefinement::streamDataFromSplittingTreeToNewTree(int newWorker) {
...
void project::base_2d_euler::observers::CreateGridButPostponeRefinement::streamDataFromJoiningTreeToMasterTree(int master) {
...
void project::base_2d_euler::observers::CreateGridButPostponeRefinement::finishAllOutstandingSendsAndReceives() {
...
void project::base_2d_euler::observers::CreateGridButPostponeRefinement::sendVertex(int position, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::grid::GridTraversalEvent&  event) {
...
void project::base_2d_euler::observers::CreateGridButPostponeRefinement::sendFace(int position, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::grid::GridTraversalEvent&  event) {
...
void project::base_2d_euler::observers::CreateGridButPostponeRefinement::sendCell(int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::grid::GridTraversalEvent&  event) {
...
void project::base_2d_euler::observers::CreateGridButPostponeRefinement::receiveAndMergeCell(int fromStack, SendReceiveContext context, const peano4::grid::GridTraversalEvent& event ) {
...
void project::base_2d_euler::observers::CreateGridButPostponeRefinement::receiveAndMergeFace(int position, int fromStack, SendReceiveContext context, const peano4::grid::GridTraversalEvent& event) {
...
void project::base_2d_euler::observers::CreateGridButPostponeRefinement::receiveAndMergeVertex(int position, int fromStack, SendReceiveContext context, const peano4::grid::GridTraversalEvent& event) {
...
void project::base_2d_euler::observers::CreateGridButPostponeRefinement::deleteAllStacks() {
