#ifndef _PROJECT_BASE_2D_EULER_OBSERVERS_CREATEGRID2EXAHYPE2_GRID_CELLLABEL2_H_
#define _PROJECT_BASE_2D_EULER_OBSERVERS_CREATEGRID2EXAHYPE2_GRID_CELLLABEL2_H_
...
class project::base_2d_euler::observers::CreateGrid2exahype2_grid_CellLabel2{
  private:
