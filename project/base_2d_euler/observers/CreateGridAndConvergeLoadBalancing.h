...
#ifndef _project_base_2d_euler_observers_CreateGridAndConvergeLoadBalancing_H_
#define _project_base_2d_euler_observers_CreateGridAndConvergeLoadBalancing_H_
...
#include "observers/CreateGridAndConvergeLoadBalancing2exahype2_solvers_fv_actionsets_InitialCondition0.h"
#include "observers/CreateGridAndConvergeLoadBalancing2exahype2_grid_FaceLabel1.h"
#include "observers/CreateGridAndConvergeLoadBalancing2exahype2_grid_CellLabel2.h"
#include "observers/CreateGridAndConvergeLoadBalancing2exahype2_solvers_fv_actionsets_AdaptivityCriterion3.h"
...
class project::base_2d_euler::observers::CreateGridAndConvergeLoadBalancing: public peano4::grid::TraversalObserver {
  public:
    /**
     * Logging device
     */
    ...
    observers::CreateGridAndConvergeLoadBalancing2exahype2_solvers_fv_actionsets_InitialCondition0   _actionSet0; 
    observers::CreateGridAndConvergeLoadBalancing2exahype2_grid_FaceLabel1   _actionSet1; 
    observers::CreateGridAndConvergeLoadBalancing2exahype2_grid_CellLabel2   _actionSet2; 
    observers::CreateGridAndConvergeLoadBalancing2exahype2_solvers_fv_actionsets_AdaptivityCriterion3   _actionSet3; 
  ...
  public:
     ...
     */
    CreateGridAndConvergeLoadBalancing(int spacetreeId = SpacetreePrototype);
