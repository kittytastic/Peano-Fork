...
#ifndef _project_base_2d_euler_observers_TimeStep_H_
#define _project_base_2d_euler_observers_TimeStep_H_
...
#include "observers/TimeStep2exahype2_solvers_fv_actionsets_DynamicAMR0.h"
#include "observers/TimeStep2exahype2_solvers_fv_actionsets_RollOverUpdatedFace1.h"
#include "observers/TimeStep2exahype2_grid_FaceLabel2.h"
#include "observers/TimeStep2exahype2_grid_CellLabel3.h"
#include "observers/TimeStep2exahype2_solvers_fv_actionsets_HandleBoundary4.h"
#include "observers/TimeStep2peano4_toolbox_blockstructured_ReconstructPatchAndApplyFunctor5.h"
#include "observers/TimeStep2exahype2_solvers_fv_actionsets_ProjectPatchOntoFaces6.h"
#include "observers/TimeStep2exahype2_solvers_fv_actionsets_AdaptivityCriterion7.h"



namespace project {namespace base_2d_euler {namespace observers {
  class TimeStep;
}}}


class project::base_2d_euler::observers::TimeStep: public peano4::grid::TraversalObserver {
  public:
    /**
     * Logging device
     */
    ...
    observers::TimeStep2exahype2_solvers_fv_actionsets_DynamicAMR0   _actionSet0; 
    observers::TimeStep2exahype2_solvers_fv_actionsets_RollOverUpdatedFace1   _actionSet1; 
    observers::TimeStep2exahype2_grid_FaceLabel2   _actionSet2; 
    observers::TimeStep2exahype2_grid_CellLabel3   _actionSet3; 
    observers::TimeStep2exahype2_solvers_fv_actionsets_HandleBoundary4   _actionSet4; 
    observers::TimeStep2peano4_toolbox_blockstructured_ReconstructPatchAndApplyFunctor5   _actionSet5; 
    observers::TimeStep2exahype2_solvers_fv_actionsets_ProjectPatchOntoFaces6   _actionSet6; 
    observers::TimeStep2exahype2_solvers_fv_actionsets_AdaptivityCriterion7   _actionSet7; 
