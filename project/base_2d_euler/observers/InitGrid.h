...
#ifndef _project_base_2d_euler_observers_InitGrid_H_
#define _project_base_2d_euler_observers_InitGrid_H_
...
class project::base_2d_euler::observers::InitGrid: public peano4::grid::TraversalObserver {
  public:
    /**
     * Logging device
     */
