...
tarch::logging::Log project::base_2d_euler::observers::InitGrid::_log( "project::base_2d_euler::observers::InitGrid" );



project::base_2d_euler::observers::InitGrid::InitGrid(int spacetreeId):
...
peano4::grid::TraversalObserver* project::base_2d_euler::observers::InitGrid::clone(int spacetreeId) {
  return new InitGrid(spacetreeId);
}

  

std::vector< peano4::grid::GridControlEvent > project::base_2d_euler::observers::InitGrid::getGridControlEvents() const {
...
void project::base_2d_euler::observers::InitGrid::beginTraversal( const tarch::la::Vector<Dimensions,double>&  x, const tarch::la::Vector<Dimensions,double>&  h ) {
...
void project::base_2d_euler::observers::InitGrid::endTraversal( const tarch::la::Vector<Dimensions,double>&  x, const tarch::la::Vector<Dimensions,double>&  h ) {
...
void project::base_2d_euler::observers::InitGrid::loadCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void project::base_2d_euler::observers::InitGrid::enterCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void project::base_2d_euler::observers::InitGrid::leaveCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void project::base_2d_euler::observers::InitGrid::storeCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void project::base_2d_euler::observers::InitGrid::exchangeAllVerticalDataExchangeStacks( int masterId ) {
...
void project::base_2d_euler::observers::InitGrid::exchangeAllHorizontalDataExchangeStacks( bool symmetricDataCardinality ) {
...
void project::base_2d_euler::observers::InitGrid::exchangeAllPeriodicBoundaryDataStacks() {
...
void project::base_2d_euler::observers::InitGrid::streamDataFromSplittingTreeToNewTree(int newWorker) {
...
void project::base_2d_euler::observers::InitGrid::streamDataFromJoiningTreeToMasterTree(int master) {
...
void project::base_2d_euler::observers::InitGrid::finishAllOutstandingSendsAndReceives() {
...
void project::base_2d_euler::observers::InitGrid::sendVertex(int position, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::grid::GridTraversalEvent&  event) {
...
void project::base_2d_euler::observers::InitGrid::sendFace(int position, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::grid::GridTraversalEvent&  event) {
...
void project::base_2d_euler::observers::InitGrid::sendCell(int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::grid::GridTraversalEvent&  event) {
...
void project::base_2d_euler::observers::InitGrid::receiveAndMergeCell(int fromStack, SendReceiveContext context, const peano4::grid::GridTraversalEvent& event ) {
...
void project::base_2d_euler::observers::InitGrid::receiveAndMergeFace(int position, int fromStack, SendReceiveContext context, const peano4::grid::GridTraversalEvent& event) {
...
void project::base_2d_euler::observers::InitGrid::receiveAndMergeVertex(int position, int fromStack, SendReceiveContext context, const peano4::grid::GridTraversalEvent& event) {
...
void project::base_2d_euler::observers::InitGrid::deleteAllStacks() {
