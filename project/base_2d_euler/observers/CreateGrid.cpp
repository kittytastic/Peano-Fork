...
tarch::logging::Log project::base_2d_euler::observers::CreateGrid::_log( "project::base_2d_euler::observers::CreateGrid" );



project::base_2d_euler::observers::CreateGrid::CreateGrid(int spacetreeId):
...
peano4::grid::TraversalObserver* project::base_2d_euler::observers::CreateGrid::clone(int spacetreeId) {
  return new CreateGrid(spacetreeId);
}

  

std::vector< peano4::grid::GridControlEvent > project::base_2d_euler::observers::CreateGrid::getGridControlEvents() const {
...
void project::base_2d_euler::observers::CreateGrid::beginTraversal( const tarch::la::Vector<Dimensions,double>&  x, const tarch::la::Vector<Dimensions,double>&  h ) {
...
void project::base_2d_euler::observers::CreateGrid::endTraversal( const tarch::la::Vector<Dimensions,double>&  x, const tarch::la::Vector<Dimensions,double>&  h ) {
...
void project::base_2d_euler::observers::CreateGrid::loadCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void project::base_2d_euler::observers::CreateGrid::enterCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void project::base_2d_euler::observers::CreateGrid::leaveCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void project::base_2d_euler::observers::CreateGrid::storeCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void project::base_2d_euler::observers::CreateGrid::exchangeAllVerticalDataExchangeStacks( int masterId ) {
...
void project::base_2d_euler::observers::CreateGrid::exchangeAllHorizontalDataExchangeStacks( bool symmetricDataCardinality ) {
...
void project::base_2d_euler::observers::CreateGrid::exchangeAllPeriodicBoundaryDataStacks() {
...
void project::base_2d_euler::observers::CreateGrid::streamDataFromSplittingTreeToNewTree(int newWorker) {
...
void project::base_2d_euler::observers::CreateGrid::streamDataFromJoiningTreeToMasterTree(int master) {
...
void project::base_2d_euler::observers::CreateGrid::finishAllOutstandingSendsAndReceives() {
...
void project::base_2d_euler::observers::CreateGrid::sendVertex(int position, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::grid::GridTraversalEvent&  event) {
...
void project::base_2d_euler::observers::CreateGrid::sendFace(int position, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::grid::GridTraversalEvent&  event) {
...
void project::base_2d_euler::observers::CreateGrid::sendCell(int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::grid::GridTraversalEvent&  event) {
...
void project::base_2d_euler::observers::CreateGrid::receiveAndMergeCell(int fromStack, SendReceiveContext context, const peano4::grid::GridTraversalEvent& event ) {
...
void project::base_2d_euler::observers::CreateGrid::receiveAndMergeFace(int position, int fromStack, SendReceiveContext context, const peano4::grid::GridTraversalEvent& event) {
...
void project::base_2d_euler::observers::CreateGrid::receiveAndMergeVertex(int position, int fromStack, SendReceiveContext context, const peano4::grid::GridTraversalEvent& event) {
...
void project::base_2d_euler::observers::CreateGrid::deleteAllStacks() {
