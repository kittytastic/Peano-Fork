...
tarch::logging::Log   project::base_2d_euler::Abstracteuler2D::Abstracteuler2D::_log( "project::base_2d_euler::Abstracteuler2D::Abstracteuler2D" );

std::bitset<Dimensions> project::base_2d_euler::Abstracteuler2D::Abstracteuler2D::PeriodicBC = project::base_2d_euler::PeriodicBC;


project::base_2d_euler::Abstracteuler2D::Abstracteuler2D():
...
double project::base_2d_euler::Abstracteuler2D::getMaxMeshSize() const {
  return getMaxPatchSize();
}


double project::base_2d_euler::Abstracteuler2D::getMinMeshSize() const {
  return getMinPatchSize();
}


double project::base_2d_euler::Abstracteuler2D::getMinPatchSize(bool ofCurrentlyRunningGridSweep) const {
  return getMinVolumeSize(ofCurrentlyRunningGridSweep) * NumberOfFiniteVolumesPerAxisPerPatch;
}


double project::base_2d_euler::Abstracteuler2D::getMaxPatchSize(bool ofCurrentlyRunningGridSweep) const {
  return getMaxVolumeSize(ofCurrentlyRunningGridSweep) * NumberOfFiniteVolumesPerAxisPerPatch;
}


double project::base_2d_euler::Abstracteuler2D::getMinVolumeSize(bool ofCurrentlyRunningGridSweep) const {
  return ofCurrentlyRunningGridSweep ? _minVolumeHThisTimeStep : _minVolumeH;
}


double project::base_2d_euler::Abstracteuler2D::getMaxVolumeSize(bool ofCurrentlyRunningGridSweep) const {
  return ofCurrentlyRunningGridSweep ? _maxVolumeHThisTimeStep : _maxVolumeH;
}


double project::base_2d_euler::Abstracteuler2D::getMinTimeStamp(bool ofCurrentlyRunningGridSweep) const {
  return ofCurrentlyRunningGridSweep ? _minTimeStampThisTimeStep : _minTimeStamp;
}


double project::base_2d_euler::Abstracteuler2D::getMaxTimeStamp(bool ofCurrentlyRunningGridSweep) const {
  return ofCurrentlyRunningGridSweep ? _maxTimeStampThisTimeStep : _maxTimeStamp;
}


double project::base_2d_euler::Abstracteuler2D::getMinTimeStepSize() const {
  return _minTimeStepSize;
}


double project::base_2d_euler::Abstracteuler2D::getMaxTimeStepSize() const {
  return _maxTimeStepSize;
}


void project::base_2d_euler::Abstracteuler2D::update(double timeStepSize, double timeStamp, double patchSize) {
...
project::base_2d_euler::Abstracteuler2D::SolverState project::base_2d_euler::Abstracteuler2D::getSolverState() const {
  return _solverState;
}



::exahype2::RefinementCommand project::base_2d_euler::Abstracteuler2D::refinementCriterion(
...
void project::base_2d_euler::Abstracteuler2D::startGridConstructionStep() {
  assertion( _solverState == SolverState::GridConstruction );
}


void project::base_2d_euler::Abstracteuler2D::finishGridConstructionStep() {
}


void project::base_2d_euler::Abstracteuler2D::startGridInitialisationStep() {
  _solverState = SolverState::GridInitialisation;
}


void project::base_2d_euler::Abstracteuler2D::finishGridInitialisationStep() {
}


void project::base_2d_euler::Abstracteuler2D::startTimeStep(
...
void project::base_2d_euler::Abstracteuler2D::finishTimeStep() {
  #ifdef Parallel
...
void project::base_2d_euler::Abstracteuler2D::startPlottingStep(
  double globalMinTimeStamp,
  double globalMaxTimeStamp,
  double globalMinTimeStepSize,
  double globalMaxTimeStepSize
...
void project::base_2d_euler::Abstracteuler2D::finishPlottingStep() {
}


std::string project::base_2d_euler::Abstracteuler2D::toString(SolverState state) {
  switch (state) {
...
bool project::base_2d_euler::Abstracteuler2D::mayPlot() const {
  return true;
}


bool project::base_2d_euler::Abstracteuler2D::isFirstGridSweepOfTimeStep() const {
  return true;
}
...
double ::project::base_2d_euler::Abstracteuler2D::getTimeStepSize() const {
