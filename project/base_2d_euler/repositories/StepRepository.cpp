...
std::string project::base_2d_euler::repositories::StepRepository::toString( Steps value ) {
  switch (value) {
...
int project::base_2d_euler::repositories::StepRepository::toProgramStep( Steps value ) {
  switch (value) {
...
project::base_2d_euler::repositories::StepRepository::Steps project::base_2d_euler::repositories::StepRepository::toStepEnum( int value ) {
  switch (value) {
