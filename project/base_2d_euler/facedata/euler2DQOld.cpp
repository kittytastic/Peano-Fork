...
project::base_2d_euler::facedata::euler2DQOld::euler2DQOld() {
}


project::base_2d_euler::facedata::euler2DQOld::euler2DQOld(const euler2DQOld& other) {
  #if PeanoDebug>=1
...
project::base_2d_euler::facedata::euler2DQOld& project::base_2d_euler::facedata::euler2DQOld::operator=(const euler2DQOld& other) {
  #if PeanoDebug>=1
  _debugX = other._debugX;
  _debugH = other._debugH;
  #endif
...
std::string project::base_2d_euler::facedata::euler2DQOld::toString() const {
...
void project::base_2d_euler::facedata::euler2DQOld::setDebugX( const tarch::la::Vector<Dimensions,double>& data ) {
  _debugX = data;
}


void project::base_2d_euler::facedata::euler2DQOld::setDebugH( const tarch::la::Vector<Dimensions,double>& data ) {
  _debugH = data;
}


tarch::la::Vector<Dimensions,double> project::base_2d_euler::facedata::euler2DQOld::getDebugX() const {
  return _debugX;
}


tarch::la::Vector<Dimensions,double> project::base_2d_euler::facedata::euler2DQOld::getDebugH() const {
  return _debugH;
}
#endif


void project::base_2d_euler::facedata::euler2DQOld::merge(const euler2DQOld& neighbour, const peano4::datamanagement::FaceMarker& marker) {
...
bool project::base_2d_euler::facedata::euler2DQOld::send(const peano4::datamanagement::FaceMarker& marker) {
  return (repositories::InstanceOfeuler2D.getSolverState()==euler2D::SolverState::GridInitialisation);
}


bool project::base_2d_euler::facedata::euler2DQOld::receiveAndMerge(const peano4::datamanagement::FaceMarker& marker) {
...
bool project::base_2d_euler::facedata::euler2DQOld::storePersistently(const peano4::datamanagement::FaceMarker& marker) {
  return not marker.willBeRefined() and repositories::InstanceOfeuler2D.getSolverState()!=euler2D::SolverState::GridConstruction;
}


bool project::base_2d_euler::facedata::euler2DQOld::loadPersistently(const peano4::datamanagement::FaceMarker& marker) {
...
#ifdef Parallel
void project::base_2d_euler::facedata::euler2DQOld::initDatatype() {
  project::base_2d_euler::facedata::euler2DQOld  instances[2];
...
void project::base_2d_euler::facedata::euler2DQOld::shutdownDatatype() {
  MPI_Type_free( &Datatype );
}
  

MPI_Datatype   project::base_2d_euler::facedata::euler2DQOld::Datatype;
#endif