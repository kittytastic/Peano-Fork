...
//
#ifndef _project_base_2d_euler_facedata_euler2DQUpdate_H_
#define _project_base_2d_euler_facedata_euler2DQUpdate_H_
...
namespace project {namespace base_2d_euler {namespace facedata {

  class euler2DQUpdate;

}}}



struct project::base_2d_euler::facedata::euler2DQUpdate {
  #if PeanoDebug>=1
  private:
  ...
  euler2DQUpdate();
  euler2DQUpdate(const euler2DQUpdate& other);
  euler2DQUpdate& operator=(const euler2DQUpdate& other);

  std::string toString() const;
  
  void merge(const euler2DQUpdate& neighbour, const peano4::datamanagement::FaceMarker& marker);
