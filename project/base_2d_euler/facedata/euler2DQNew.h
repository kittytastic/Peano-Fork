...
//
#ifndef _project_base_2d_euler_facedata_euler2DQNew_H_
#define _project_base_2d_euler_facedata_euler2DQNew_H_
...
struct project::base_2d_euler::facedata::euler2DQNew {
  #if PeanoDebug>=1
  private:
