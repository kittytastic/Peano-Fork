...
project::base_2d_euler::facedata::euler2DQNew::euler2DQNew() {
}


project::base_2d_euler::facedata::euler2DQNew::euler2DQNew(const euler2DQNew& other) {
  #if PeanoDebug>=1
...
project::base_2d_euler::facedata::euler2DQNew& project::base_2d_euler::facedata::euler2DQNew::operator=(const euler2DQNew& other) {
  #if PeanoDebug>=1
  _debugX = other._debugX;
  _debugH = other._debugH;
  #endif
...
std::string project::base_2d_euler::facedata::euler2DQNew::toString() const {
...
void project::base_2d_euler::facedata::euler2DQNew::setDebugX( const tarch::la::Vector<Dimensions,double>& data ) {
  _debugX = data;
}


void project::base_2d_euler::facedata::euler2DQNew::setDebugH( const tarch::la::Vector<Dimensions,double>& data ) {
  _debugH = data;
}


tarch::la::Vector<Dimensions,double> project::base_2d_euler::facedata::euler2DQNew::getDebugX() const {
  return _debugX;
}


tarch::la::Vector<Dimensions,double> project::base_2d_euler::facedata::euler2DQNew::getDebugH() const {
  return _debugH;
}
#endif


void project::base_2d_euler::facedata::euler2DQNew::merge(const euler2DQNew& neighbour, const peano4::datamanagement::FaceMarker& marker) {
...
bool project::base_2d_euler::facedata::euler2DQNew::send(const peano4::datamanagement::FaceMarker& marker) {
  return true;
}


bool project::base_2d_euler::facedata::euler2DQNew::receiveAndMerge(const peano4::datamanagement::FaceMarker& marker) {
  return true;
}


bool project::base_2d_euler::facedata::euler2DQNew::storePersistently(const peano4::datamanagement::FaceMarker& marker) {
  return not marker.willBeRefined() and repositories::InstanceOfeuler2D.getSolverState()!=euler2D::SolverState::GridConstruction;
}


bool project::base_2d_euler::facedata::euler2DQNew::loadPersistently(const peano4::datamanagement::FaceMarker& marker) {
...
#ifdef Parallel
void project::base_2d_euler::facedata::euler2DQNew::initDatatype() {
  project::base_2d_euler::facedata::euler2DQNew  instances[2];
...
void project::base_2d_euler::facedata::euler2DQNew::shutdownDatatype() {
  MPI_Type_free( &Datatype );
}
  

MPI_Datatype   project::base_2d_euler::facedata::euler2DQNew::Datatype;
#endif