...
//
#ifndef _project_base_2d_euler_facedata_euler2DQOld_H_
#define _project_base_2d_euler_facedata_euler2DQOld_H_
...
struct project::base_2d_euler::facedata::euler2DQOld {
  #if PeanoDebug>=1
  private:
  ...
  euler2DQOld();
  euler2DQOld(const euler2DQOld& other);
  euler2DQOld& operator=(const euler2DQOld& other);

  std::string toString() const;
  
  void merge(const euler2DQOld& neighbour, const peano4::datamanagement::FaceMarker& marker);
