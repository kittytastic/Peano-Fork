...
using namespace project::base_2d_euler;
...
int main(int argc, char** argv) {
  ...
  project::base_2d_euler::repositories::DataRepository::initDatatypes();
  ...
  project::base_2d_euler::repositories::DataRepository::shutdownDatatypes();
