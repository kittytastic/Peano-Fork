...
//
#ifndef _project_base_2d_euler_Abstracteuler2D_H_
#define _project_base_2d_euler_Abstracteuler2D_H_
...
namespace project {namespace base_2d_euler {
...
class project::base_2d_euler::Abstracteuler2D: public ::exahype2::Solver {
  public:
    /**
