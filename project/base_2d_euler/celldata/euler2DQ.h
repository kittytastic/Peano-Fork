...
//
#ifndef _project_base_2d_euler_celldata_euler2DQ_H_
#define _project_base_2d_euler_celldata_euler2DQ_H_
...
namespace project {namespace base_2d_euler {namespace celldata {
...
struct project::base_2d_euler::celldata::euler2DQ {
  #if PeanoDebug>=1
  private:
