...
tarch::logging::Log   project::base_2d_euler_inline::euler2D::_log( "project::base_2d_euler_inline::euler2D" );
...
void project::base_2d_euler_inline::euler2D::initialCondition(
...
void project::base_2d_euler_inline::euler2D::boundaryConditions(
...
double ::project::base_2d_euler_inline::euler2D::maxEigenvalue(
...
void ::project::base_2d_euler_inline::euler2D::flux(
  const double * __restrict__ Q, // Q[4+0],
  const tarch::la::Vector<Dimensions,double>&  faceCentre,
  const tarch::la::Vector<Dimensions,double>&  volumeH,
  double                                       t,
