...
//
#ifndef _project_base_2d_euler_inline_euler2D_H_
#define _project_base_2d_euler_inline_euler2D_H_
...
class project::base_2d_euler_inline::euler2D: public Abstracteuler2D {
  private:
