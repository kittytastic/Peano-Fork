...
(cd Euler2D/generated; git clean -xdf; python euler2D.py; make clean; git restore observers/TimeStep2peano4_toolbox_blockstructured_ReconstructPatchAndApplyFunctor5.cpp; python ../../fix_makefile.py swe.g.cpp)>>/dev/null
