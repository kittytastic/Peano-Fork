...
YATeTo (Yet Another Tensor Toolbox) \cite{YATeTo} takes this approach of a translation expert.
...
YATeTo shows us that dynamic code generation that increases single core throughput can have a drastic impact on the performance of an entire of PDE solver; validating our focus on improving single core performance using dynamic code generation.
