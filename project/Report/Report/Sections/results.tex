...
This testing is preformed by a small program, called \texttt{KernelCompare}, that we created.
...
However, enabling this flag does has large knock on consequences in performance.
