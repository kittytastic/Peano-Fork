...
As disgusted in \ref{sec:DAG} DAGs are a fundamental feature in \phlat, as such we can give an alternative definition of \phlat{}'s domain as: any problem that can be described as a DAG.
...
% DAG Transforms
In the DAG transform stage a series of user defined transforms can be applied to the DAG, followed by some default transforms.
...
Another notable user transform we investigated was the removal of duplicated computation.
...
Once this is complete the IR is transformed into a its tight form.
