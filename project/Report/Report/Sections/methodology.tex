...
These DAG builders can then be passed to preexisting \proc{Patch Update} and Rusanov DAG builders.
The \proc{Patch Update} and Rusanov DAG builder will then create a new user DAG for every instance of a call to a user function.
