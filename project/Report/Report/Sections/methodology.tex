...
\sbox{\measurebox}{%
  \begin{minipage}{.65\textwidth} \centering
        \subfloat[]{\label{fig:figB}\usebox{\firstlisting}}
        \vspace{1em}
...
\usebox{\measurebox}\qquad
    \begin{minipage}[][\ht\measurebox][c]{.25\textwidth}
      \subfloat[]{\label{fig:figA}\includegraphics[width=\textwidth]{tight_vs_loose.png}}
