...
\sbox{\measurebox}{%
  \begin{minipage}[b]{.33\textwidth}
      \subfloat[]{\label{fig:figA}\includegraphics[width=\textwidth,height=5cm]{tight_vs_loose.png}}
  \end{minipage}
}
...
\usebox{\measurebox}\qquad
    \begin{minipage}[b][\ht\measurebox][s]{.33\textwidth}
        \centering
        \subfloat[]{\label{fig:figB}\includegraphics[width=\textwidth,height=2cm]{tight_vs_loose.png}}

        \vfill

        \subfloat[]{\label{fig:figC}\includegraphics[width=\textwidth,height=2cm]{tight_vs_loose.png}}
    \end{minipage}
