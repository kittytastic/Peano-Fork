This paper presented using a complier that takes an input problem encoded as a DAG and generate compiled kernel consisting of a single monolithic function.
