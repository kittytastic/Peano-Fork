This paper presents using a complier that takes an input problem encoded as a DAG and generating a ``compiled kernel'' which is a single monolithic function.
