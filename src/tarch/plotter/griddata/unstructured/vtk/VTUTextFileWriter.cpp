...
tarch::plotter::griddata::unstructured::vtk::VTUTextFileWriter::VTUTextFileWriter(const std::string&  fileName, const std::string&  indexFileName, tarch::plotter::VTUTimeSeriesWriter::IndexFileMode mode, const int precision):
...
/*
  switch (mode) {
    case tarch::plotter::VTUTimeSeriesWriter::IndexFileMode::CreateNew:
      tarch::plotter::VTUTimeSeriesWriter::createEmptyNewFile(indexFile);
      break;
    case tarch::plotter::VTUTimeSeriesWriter::IndexFileMode::AppendNewDataSet:
      tarch::plotter::VTUTimeSeriesWriter::appendNewDataSet(indexFile);
      break;
    case tarch::plotter::VTUTimeSeriesWriter::IndexFileMode::AppendNewData:
    case tarch::plotter::VTUTimeSeriesWriter::IndexFileMode::NoIndexFile:
      break;
  }
*/
}
