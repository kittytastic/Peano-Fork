...
tarch::plotter::griddata::unstructured::vtk::VTUTextFileWriter::VTUTextFileWriter(const std::string& indexFile, tarch::plotter::VTUTimeSeriesWriter::IndexFileMode modeFile, const int precision):
...
/*
  switch (mode) {
    case IndexFileMode::CreateNew:
      tarch::plotter::VTUTimeSeriesWriter::createEmptyIndexFile(indexFile);
      break;
    case IndexFileMode::AppendNewDataSet:
      tarch::plotter::VTUTimeSeriesWriter::addNewDatasetToIndexFile(indexFile);
      break;
