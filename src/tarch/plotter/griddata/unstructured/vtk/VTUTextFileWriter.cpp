...
tarch::plotter::griddata::unstructured::vtk::VTUTextFileWriter::VTUTextFileWriter(const std::string&  fileName, const std::string&  indexFileName, tarch::plotter::PVDTimeSeriesWriter::IndexFileMode mode, const int precision):
  ...
  switch (mode) {
    ...
    case tarch::plotter::PVDTimeSeriesWriter::IndexFileMode::AppendNewData:
      tarch::plotter::PVDTimeSeriesWriter::appendNewData(indexFileName, fileName + ".vtu");
      break;
