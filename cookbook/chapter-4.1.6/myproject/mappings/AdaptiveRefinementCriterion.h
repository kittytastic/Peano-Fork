...
#ifndef MYPROJECT_MAPPINGS_AdaptiveRefinementCriterion_H_
#define MYPROJECT_MAPPINGS_AdaptiveRefinementCriterion_H_
 ...
 */
class myproject::mappings::AdaptiveRefinementCriterion {
  private:
    /**
  ...
  public:
     ...
     */
    AdaptiveRefinementCriterion(const AdaptiveRefinementCriterion& masterThread);
    #endif

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~AdaptiveRefinementCriterion();
     ...
     */   
    void mergeWithWorkerThread(const AdaptiveRefinementCriterion& workerThread);
    #endif
 ...
 if ( fineGridVertex.isAdjacentToDomainOf( tarch::parallel::Node::getInstance().getRank() ) ) {
   ...
     ...
     *
     * @see AdaptiveRefinementCriterion()
     */
    void beginIteration(
