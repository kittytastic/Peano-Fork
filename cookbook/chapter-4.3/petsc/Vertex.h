...
#ifndef _PETSC_VERTEX_H_ 
#define _PETSC_VERTEX_H_


#include "petsc/records/Vertex.h"
 ...
 */
class petsc::Vertex: public peano::grid::Vertex< petsc::records::Vertex > { 
  private: 
    typedef class peano::grid::Vertex< petsc::records::Vertex >  Base;
