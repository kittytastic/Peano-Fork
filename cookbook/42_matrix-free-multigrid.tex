...
Or you may decide to merge the predefined mapping 

 Adaptives Verfeineren. Dann muss man richtig interpolieren
bei neuen Werten, sonst gibt es Kaese



\begin{center}
  \includegraphics[width=0.24\textwidth]{42_matrix-free-multigrid/DynamicB.png}
\end{center}
