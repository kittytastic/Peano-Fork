...
\begin{center}
 \begin{tabular}{lp{10cm}}
  ...
  $\Delta $ is used. Not stable at the moment.
   \\
  \texttt{--with-nvidia} & Build against the NVIDIA NVTX SDK such that NVIDIA
  specific logging/tracing becomes available. Ensure that your CXXFLAGS set the
  right include path\footnote{It is
