...
\begin{remark}
 ...
 pass, I recommend that you first add IO (VTK) and then parallelisation. After
 each invocation of the configure script with different parameters, you will
 have to rebuild (and maybe reinstall) the code.
\end{remark}
