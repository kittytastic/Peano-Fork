...
flags.
Translate the whole \Peano\ core.
...
However, you have to explicitly switch GPUs on by invoking a routine on the 
solver.


Third, write alternatives of those solver routines that have to be deployed
to the GPU.
