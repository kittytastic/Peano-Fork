...
Dynamic adaptivity however is added via a one-liner:
...
Finally, dynamic AMR in \ExaHyPE\ is simple to realise if you make your result
depend on the input parameter \texttt{t}.
It is however important to keep in mind that refinement requests are not
