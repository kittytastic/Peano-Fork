...
First, your solver has to provide a couple of additional routines. 
I propose that you include
\begin{code}
#include "tarch/multicore/multicore.h"
\end{code} 

\noindent
and protect all modifications from hereon with 
\begin{code}
#ifdef 
\end{code}
...
\begin{itemize}
  \item There have to be side-effect and state-free variants of your core
  numerics routines (such as fluxes and eigenvalues).
  \item These additional variants accept one more argument
\end{itemize} 
