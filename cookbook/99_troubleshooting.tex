...
\begin{itemize}
  \item {\textbf The PDT does not pass as the jar file is built with the wrong Java
...
\begin{itemize}
  \item {\textbf How can I find out the location of a cell}. See the documentation
  of the \texttt{VertexEnumerator}. The object has routines to query cell
  position, size and level in the spacetree.
  \item {\textbf The adaptivity pattern lacks behing my adaptivity instructions}.
  ...
  \end{itemize}
  \item {\textbf I need the state object in my mapping}. Create a copy of the state
...
\begin{itemize}
  \item {\textbf Does Peano support MPI-2?}. Yes, you can switch to MPI-2 if you add
  ...
  ideas to follow-up:
    ...
    \end{enumerate}
  \item {\textbf My MPI version complains about a datatype \texttt{MPI\_CXX\_BOOL}}. 
