...
//
#ifndef _examples_exahype2_loh1_facedata_LOH1QNew_H_
#define _examples_exahype2_loh1_facedata_LOH1QNew_H_
...
struct examples::exahype2::loh1::facedata::LOH1QNew {
  #if PeanoDebug>=1
  private:
  ...
  LOH1QNew();
  LOH1QNew(const LOH1QNew& other);
  LOH1QNew& operator=(const LOH1QNew& other);

  std::string toString() const;
  
  void merge(const LOH1QNew& neighbour, const peano4::datamanagement::FaceMarker& marker);
