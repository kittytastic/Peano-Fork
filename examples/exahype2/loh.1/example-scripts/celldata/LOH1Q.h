...
//
#ifndef _examples_exahype2_loh1_celldata_LOH1Q_H_
#define _examples_exahype2_loh1_celldata_LOH1Q_H_
...
namespace examples {namespace exahype2 {namespace loh1 {namespace celldata {
...
struct examples::exahype2::loh1::celldata::LOH1Q {
  #if PeanoDebug>=1
  private:
  ...
  void merge(const LOH1Q& neighbour, const peano4::datamanagement::CellMarker& marker);
