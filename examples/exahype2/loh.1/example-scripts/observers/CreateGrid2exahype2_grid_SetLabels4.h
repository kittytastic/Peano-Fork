#ifndef _EXAMPLES_EXAHYPE2_LOH1_OBSERVERS_CREATEGRID2EXAHYPE2_GRID_SETLABELS4_H_
#define _EXAMPLES_EXAHYPE2_LOH1_OBSERVERS_CREATEGRID2EXAHYPE2_GRID_SETLABELS4_H_
...
namespace loh1 {
namespace observers {
  class CreateGrid2exahype2_grid_SetLabels4;
}
}
}
}
class examples::exahype2::loh1::observers::CreateGrid2exahype2_grid_SetLabels4{
  private:
  ...
  public:
     ...
     */      
    CreateGrid2exahype2_grid_SetLabels4(int treeNumber);

    ~CreateGrid2exahype2_grid_SetLabels4();
