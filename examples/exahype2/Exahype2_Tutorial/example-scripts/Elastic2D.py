...
project = exahype2.Project( ["examples", "exahype2", "elastic2d"], "elastic2d", ".", executable="ELASTIC2D" )
...
print("Done. Executable is: Elastic2D")
print( "Convert any output via pvpython ~/git/Peano/python/peano4/visualisation/render.py solution-elastic2d.peano-patch-file")