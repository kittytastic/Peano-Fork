...
project = exahype2.Project( ["examples", "exahype2", "elastic3d"], "elastic3d", ".", executable="ELASTIC3D" )
...
print("Done. Executable is: Elastic3D")
print( "Convert any output via pvpython ~/git/Peano/python/peano4/visualisation/render.py solution-elastic3d.peano-patch-file")