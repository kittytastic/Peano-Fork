...
//
#ifndef _examples_exahype2_swe_facedata_SWEQ_H_
#define _examples_exahype2_swe_facedata_SWEQ_H_
...
struct examples::exahype2::swe::facedata::SWEQ {
  #if PeanoDebug>=1
  private:
  ...
  void merge(const SWEQ& neighbour, const peano4::datamanagement::FaceMarker& marker);
