...
//
#ifndef _examples_exahype2_swe_facedata_SWEQNew_H_
#define _examples_exahype2_swe_facedata_SWEQNew_H_
...
namespace examples {namespace exahype2 {namespace swe {namespace facedata {
...
struct examples::exahype2::swe::facedata::SWEQNew {
  #if PeanoDebug>=1
  private:
  ...
  SWEQNew();
  SWEQNew(const SWEQNew& other);
  SWEQNew& operator=(const SWEQNew& other);

  std::string toString() const;
  
  void merge(const SWEQNew& neighbour, const peano4::datamanagement::FaceMarker& marker);
