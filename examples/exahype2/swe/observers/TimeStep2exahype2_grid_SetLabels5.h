#ifndef _EXAMPLES_EXAHYPE2_SWE_OBSERVERS_TIMESTEP2EXAHYPE2_GRID_SETLABELS5_H_
#define _EXAMPLES_EXAHYPE2_SWE_OBSERVERS_TIMESTEP2EXAHYPE2_GRID_SETLABELS5_H_
...
class examples::exahype2::swe::observers::TimeStep2exahype2_grid_SetLabels5{
  private:
