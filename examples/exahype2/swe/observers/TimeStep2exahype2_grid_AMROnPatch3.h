#ifndef _EXAMPLES_EXAHYPE2_SWE_OBSERVERS_TIMESTEP2EXAHYPE2_GRID_AMRONPATCH3_H_
#define _EXAMPLES_EXAHYPE2_SWE_OBSERVERS_TIMESTEP2EXAHYPE2_GRID_AMRONPATCH3_H_
...
class examples::exahype2::swe::observers::TimeStep2exahype2_grid_AMROnPatch3{
  private:
