...
#ifndef _examples_exahype2_swe_observers_PlotSolution_H_
#define _examples_exahype2_swe_observers_PlotSolution_H_
...
class examples::exahype2::swe::observers::PlotSolution: public peano4::grid::TraversalObserver {
  public:
    /**
     * Logging device
     */
