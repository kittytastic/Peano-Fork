...
#ifndef _examples_exahype2_swe_observers_TimeStep_H_
#define _examples_exahype2_swe_observers_TimeStep_H_
...
class examples::exahype2::swe::observers::TimeStep: public peano4::grid::TraversalObserver {
  public:
    /**
     * Logging device
     */
