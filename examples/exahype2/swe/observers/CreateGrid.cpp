...
tarch::logging::Log examples::exahype2::swe::observers::CreateGrid::_log( "examples::exahype2::swe::observers::CreateGrid" );


  
examples::exahype2::swe::observers::CreateGrid::CreateGrid(int spacetreeId):
...
peano4::grid::TraversalObserver* examples::exahype2::swe::observers::CreateGrid::clone(int spacetreeId) {
  return new CreateGrid(spacetreeId);
}
  
  
  
std::vector< peano4::grid::GridControlEvent > examples::exahype2::swe::observers::CreateGrid::getGridControlEvents() const {
...
void examples::exahype2::swe::observers::CreateGrid::beginTraversal( const tarch::la::Vector<Dimensions,double>&  x, const tarch::la::Vector<Dimensions,double>&  h ) {
...
void examples::exahype2::swe::observers::CreateGrid::endTraversal( const tarch::la::Vector<Dimensions,double>&  x, const tarch::la::Vector<Dimensions,double>&  h ) {
...
void examples::exahype2::swe::observers::CreateGrid::enterCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void examples::exahype2::swe::observers::CreateGrid::leaveCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void examples::exahype2::swe::observers::CreateGrid::exchangeAllVerticalDataExchangeStacks( int masterId ) {
...
void examples::exahype2::swe::observers::CreateGrid::exchangeAllHorizontalDataExchangeStacks( bool symmetricDataCardinality ) {
...
void examples::exahype2::swe::observers::CreateGrid::exchangeAllPeriodicBoundaryDataStacks() {
...
void examples::exahype2::swe::observers::CreateGrid::streamDataFromSplittingTreeToNewTree(int newWorker) {
...
void examples::exahype2::swe::observers::CreateGrid::streamDataFromJoiningTreeToMasterTree(int master) {
...
void examples::exahype2::swe::observers::CreateGrid::finishAllOutstandingSendsAndReceives() {
...
void examples::exahype2::swe::observers::CreateGrid::sendVertex(int inOutStack, int relativePositionOnInOutStack, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::datamanagement::VertexMarker& marker) {
...
void examples::exahype2::swe::observers::CreateGrid::sendFace(int inOutStack, int relativePositionOnInOutStack, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::datamanagement::FaceMarker& marker) {
...
void examples::exahype2::swe::observers::CreateGrid::sendCell(int inOutStack, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::datamanagement::CellMarker& marker) {
...
void examples::exahype2::swe::observers::CreateGrid::receiveAndMergeFace(const peano4::grid::GridTraversalEvent&  event, int positionWithinCell, int inOutStack, int relativePositionOnInOutStack, int fromStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::datamanagement::FaceMarker& marker) {
...
void examples::exahype2::swe::observers::CreateGrid::deleteAllStacks() {
