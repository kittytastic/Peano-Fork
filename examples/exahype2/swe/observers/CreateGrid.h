...
#ifndef _examples_exahype2_swe_observers_CreateGrid_H_
#define _examples_exahype2_swe_observers_CreateGrid_H_
...
class examples::exahype2::swe::observers::CreateGrid: public peano4::grid::TraversalObserver {
  public:
    /**
     * Logging device
     */
