...
#ifndef _examples_exahype2_swe_observers_CreateGridButPostponeRefinement_H_
#define _examples_exahype2_swe_observers_CreateGridButPostponeRefinement_H_
...
class examples::exahype2::swe::observers::CreateGridButPostponeRefinement: public peano4::grid::TraversalObserver {
  public:
    /**
     * Logging device
     */
