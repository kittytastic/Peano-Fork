...
//
#ifndef _examples_exahype2_swe_celldata_SWEQ_H_
#define _examples_exahype2_swe_celldata_SWEQ_H_
...
namespace examples {namespace exahype2 {namespace swe {namespace celldata {
...
struct examples::exahype2::swe::celldata::SWEQ {
  #if PeanoDebug>=1
  private:
  ...
  SWEQ();
  SWEQ(const SWEQ& other);
  SWEQ& operator=(const SWEQ& other);

  std::string toString() const;
  
  void merge(const SWEQ& neighbour, const peano4::datamanagement::CellMarker& marker);
