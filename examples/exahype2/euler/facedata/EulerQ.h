...
//
#ifndef _examples_exahype2_euler_facedata_EulerQ_H_
#define _examples_exahype2_euler_facedata_EulerQ_H_
...
struct examples::exahype2::euler::facedata::EulerQ {
  #if PeanoDebug>=1
  private:
  ...
  void merge(const EulerQ& neighbour, const peano4::datamanagement::FaceMarker& marker);
