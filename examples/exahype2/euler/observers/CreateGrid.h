...
#ifndef _examples_exahype2_euler_observers_CreateGrid_H_
#define _examples_exahype2_euler_observers_CreateGrid_H_
...
#include "observers/CreateGrid2exahype2_grid_EnclaveLabels2.h"
#include "observers/CreateGrid2exahype2_grid_SetLabels3.h"
...
class examples::exahype2::euler::observers::CreateGrid: public peano4::grid::TraversalObserver {
  public:
    /**
     * Logging device
     */
    ...
    observers::CreateGrid2exahype2_grid_EnclaveLabels2   _actionSet2; 
    observers::CreateGrid2exahype2_grid_SetLabels3   _actionSet3; 
