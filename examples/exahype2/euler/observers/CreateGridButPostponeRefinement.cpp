...
tarch::logging::Log examples::exahype2::euler::observers::CreateGridButPostponeRefinement::_log( "examples::exahype2::euler::observers::CreateGridButPostponeRefinement" );


  
examples::exahype2::euler::observers::CreateGridButPostponeRefinement::CreateGridButPostponeRefinement(int spacetreeId):
...
peano4::grid::TraversalObserver* examples::exahype2::euler::observers::CreateGridButPostponeRefinement::clone(int spacetreeId) {
  return new CreateGridButPostponeRefinement(spacetreeId);
}
  
  
  
std::vector< peano4::grid::GridControlEvent > examples::exahype2::euler::observers::CreateGridButPostponeRefinement::getGridControlEvents() const {
...
void examples::exahype2::euler::observers::CreateGridButPostponeRefinement::beginTraversal( const tarch::la::Vector<Dimensions,double>&  x, const tarch::la::Vector<Dimensions,double>&  h ) {
...
void examples::exahype2::euler::observers::CreateGridButPostponeRefinement::endTraversal( const tarch::la::Vector<Dimensions,double>&  x, const tarch::la::Vector<Dimensions,double>&  h ) {
...
void examples::exahype2::euler::observers::CreateGridButPostponeRefinement::enterCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void examples::exahype2::euler::observers::CreateGridButPostponeRefinement::leaveCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void examples::exahype2::euler::observers::CreateGridButPostponeRefinement::exchangeAllVerticalDataExchangeStacks( int masterId ) {
...
void examples::exahype2::euler::observers::CreateGridButPostponeRefinement::exchangeAllHorizontalDataExchangeStacks( bool symmetricDataCardinality ) {
...
void examples::exahype2::euler::observers::CreateGridButPostponeRefinement::exchangeAllPeriodicBoundaryDataStacks() {
...
void examples::exahype2::euler::observers::CreateGridButPostponeRefinement::streamDataFromSplittingTreeToNewTree(int newWorker) {
...
void examples::exahype2::euler::observers::CreateGridButPostponeRefinement::streamDataFromJoiningTreeToMasterTree(int master) {
...
void examples::exahype2::euler::observers::CreateGridButPostponeRefinement::finishAllOutstandingSendsAndReceives() {
...
void examples::exahype2::euler::observers::CreateGridButPostponeRefinement::sendVertex(int inOutStack, int relativePositionOnInOutStack, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::datamanagement::VertexMarker& marker) {
...
void examples::exahype2::euler::observers::CreateGridButPostponeRefinement::sendFace(int inOutStack, int relativePositionOnInOutStack, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::datamanagement::FaceMarker& marker) {
...
void examples::exahype2::euler::observers::CreateGridButPostponeRefinement::sendCell(int inOutStack, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::datamanagement::CellMarker& marker) {
...
void examples::exahype2::euler::observers::CreateGridButPostponeRefinement::deleteAllStacks() {
