#ifndef _EXAMPLES_EXAHYPE2_EULER_OBSERVERS_INITGRID2PEANO4_TOOLBOX_BLOCKSTRUCTURED_APPLYFUNCTORONPATCH1_H_
#define _EXAMPLES_EXAHYPE2_EULER_OBSERVERS_INITGRID2PEANO4_TOOLBOX_BLOCKSTRUCTURED_APPLYFUNCTORONPATCH1_H_
...
namespace euler {
namespace observers {
  class InitGrid2peano4_toolbox_blockstructured_ApplyFunctorOnPatch1;
}
}
}
}
class examples::exahype2::euler::observers::InitGrid2peano4_toolbox_blockstructured_ApplyFunctorOnPatch1{
  private:
  ...
  public:
     ...
     */      
    InitGrid2peano4_toolbox_blockstructured_ApplyFunctorOnPatch1(int treeNumber);

    ~InitGrid2peano4_toolbox_blockstructured_ApplyFunctorOnPatch1();
