#ifndef _EXAMPLES_EXAHYPE2_EULER_OBSERVERS_CREATEGRIDBUTPOSTPONEREFINEMENT2EXAHYPE2_GRID_ENCLAVELABELS1_H_
#define _EXAMPLES_EXAHYPE2_EULER_OBSERVERS_CREATEGRIDBUTPOSTPONEREFINEMENT2EXAHYPE2_GRID_ENCLAVELABELS1_H_
...
namespace euler {
namespace observers {
  class CreateGridButPostponeRefinement2exahype2_grid_EnclaveLabels1;
}
}
}
}
class examples::exahype2::euler::observers::CreateGridButPostponeRefinement2exahype2_grid_EnclaveLabels1{
  private:
  ...
  public:
     ...
     */      
    CreateGridButPostponeRefinement2exahype2_grid_EnclaveLabels1(int treeNumber);

    ~CreateGridButPostponeRefinement2exahype2_grid_EnclaveLabels1();
