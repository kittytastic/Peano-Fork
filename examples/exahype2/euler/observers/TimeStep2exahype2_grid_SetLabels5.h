#ifndef _EXAMPLES_EXAHYPE2_EULER_OBSERVERS_TIMESTEP2EXAHYPE2_GRID_SETLABELS5_H_
#define _EXAMPLES_EXAHYPE2_EULER_OBSERVERS_TIMESTEP2EXAHYPE2_GRID_SETLABELS5_H_
...
namespace euler {
namespace observers {
  class TimeStep2exahype2_grid_SetLabels5;
}
}
}
}
class examples::exahype2::euler::observers::TimeStep2exahype2_grid_SetLabels5{
  private:
  ...
  public:
     ...
     */      
    TimeStep2exahype2_grid_SetLabels5(int treeNumber);

    ~TimeStep2exahype2_grid_SetLabels5();
