#ifndef _EXAMPLES_EXAHYPE2_EULER_OBSERVERS_INITGRID2EXAHYPE2_GRID_SETLABELS2_H_
#define _EXAMPLES_EXAHYPE2_EULER_OBSERVERS_INITGRID2EXAHYPE2_GRID_SETLABELS2_H_
...
namespace euler {
namespace observers {
  class InitGrid2exahype2_grid_SetLabels2;
}
}
}
}
class examples::exahype2::euler::observers::InitGrid2exahype2_grid_SetLabels2{
  private:
  ...
  public:
     ...
     */      
    InitGrid2exahype2_grid_SetLabels2(int treeNumber);

    ~InitGrid2exahype2_grid_SetLabels2();
