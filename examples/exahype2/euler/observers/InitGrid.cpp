...
tarch::logging::Log examples::exahype2::euler::observers::InitGrid::_log( "examples::exahype2::euler::observers::InitGrid" );


  
examples::exahype2::euler::observers::InitGrid::InitGrid(int spacetreeId):
...
peano4::grid::TraversalObserver* examples::exahype2::euler::observers::InitGrid::clone(int spacetreeId) {
  return new InitGrid(spacetreeId);
}
  
  
  
std::vector< peano4::grid::GridControlEvent > examples::exahype2::euler::observers::InitGrid::getGridControlEvents() const {
...
void examples::exahype2::euler::observers::InitGrid::beginTraversal( const tarch::la::Vector<Dimensions,double>&  x, const tarch::la::Vector<Dimensions,double>&  h ) {
...
void examples::exahype2::euler::observers::InitGrid::endTraversal( const tarch::la::Vector<Dimensions,double>&  x, const tarch::la::Vector<Dimensions,double>&  h ) {
...
void examples::exahype2::euler::observers::InitGrid::enterCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void examples::exahype2::euler::observers::InitGrid::leaveCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void examples::exahype2::euler::observers::InitGrid::exchangeAllVerticalDataExchangeStacks( int masterId ) {
...
void examples::exahype2::euler::observers::InitGrid::exchangeAllHorizontalDataExchangeStacks( bool symmetricDataCardinality ) {
...
void examples::exahype2::euler::observers::InitGrid::exchangeAllPeriodicBoundaryDataStacks() {
...
void examples::exahype2::euler::observers::InitGrid::streamDataFromSplittingTreeToNewTree(int newWorker) {
...
void examples::exahype2::euler::observers::InitGrid::streamDataFromJoiningTreeToMasterTree(int master) {
...
void examples::exahype2::euler::observers::InitGrid::finishAllOutstandingSendsAndReceives() {
...
void examples::exahype2::euler::observers::InitGrid::sendVertex(int inOutStack, int relativePositionOnInOutStack, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::datamanagement::VertexMarker& marker) {
...
void examples::exahype2::euler::observers::InitGrid::sendFace(int inOutStack, int relativePositionOnInOutStack, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::datamanagement::FaceMarker& marker) {
...
void examples::exahype2::euler::observers::InitGrid::sendCell(int inOutStack, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::datamanagement::CellMarker& marker) {
...
void examples::exahype2::euler::observers::InitGrid::receiveAndMergeFace(const peano4::grid::GridTraversalEvent&  event, int positionWithinCell, int inOutStack, int relativePositionOnInOutStack, int fromStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::datamanagement::FaceMarker& marker) {
...
void examples::exahype2::euler::observers::InitGrid::deleteAllStacks() {
