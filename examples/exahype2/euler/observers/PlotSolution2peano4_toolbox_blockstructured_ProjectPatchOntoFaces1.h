#ifndef _EXAMPLES_EXAHYPE2_EULER_OBSERVERS_PLOTSOLUTION2PEANO4_TOOLBOX_BLOCKSTRUCTURED_PROJECTPATCHONTOFACES1_H_
#define _EXAMPLES_EXAHYPE2_EULER_OBSERVERS_PLOTSOLUTION2PEANO4_TOOLBOX_BLOCKSTRUCTURED_PROJECTPATCHONTOFACES1_H_
...
namespace euler {
namespace observers {
  class PlotSolution2peano4_toolbox_blockstructured_ProjectPatchOntoFaces1;
}
}
}
}
class examples::exahype2::euler::observers::PlotSolution2peano4_toolbox_blockstructured_ProjectPatchOntoFaces1{
  private:
  ...
  public:
     ...
     */      
    PlotSolution2peano4_toolbox_blockstructured_ProjectPatchOntoFaces1(int treeNumber);

    ~PlotSolution2peano4_toolbox_blockstructured_ProjectPatchOntoFaces1();
