#ifndef _EXAMPLES_EXAHYPE2_EULER_OBSERVERS_TIMESTEP2EXAHYPE2_GRID_SETLABELS7_H_
#define _EXAMPLES_EXAHYPE2_EULER_OBSERVERS_TIMESTEP2EXAHYPE2_GRID_SETLABELS7_H_
...
namespace euler {
namespace observers {
  class TimeStep2exahype2_grid_SetLabels7;
}
}
}
}
class examples::exahype2::euler::observers::TimeStep2exahype2_grid_SetLabels7{
  private:
  ...
  public:
     ...
     */      
    TimeStep2exahype2_grid_SetLabels7(int treeNumber);
