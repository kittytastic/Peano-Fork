#ifndef _EXAMPLES_EXAHYPE2_EULER_OBSERVERS_TIMESTEP2EXAHYPE2_GRID_ENCLAVELABELS5_H_
#define _EXAMPLES_EXAHYPE2_EULER_OBSERVERS_TIMESTEP2EXAHYPE2_GRID_ENCLAVELABELS5_H_
...
namespace euler {
namespace observers {
  class TimeStep2exahype2_grid_EnclaveLabels5;
}
}
}
}
class examples::exahype2::euler::observers::TimeStep2exahype2_grid_EnclaveLabels5{
  private:
  ...
  public:
     ...
     */      
    TimeStep2exahype2_grid_EnclaveLabels5(int treeNumber);

    ~TimeStep2exahype2_grid_EnclaveLabels5();
