#ifndef _EXAMPLES_EXAHYPE2_EULER_OBSERVERS_CREATEGRIDBUTPOSTPONEREFINEMENT2PEANO4_TOOLBOX_BLOCKSTRUCTURED_PROJECTPATCHONTOFACES0_H_
#define _EXAMPLES_EXAHYPE2_EULER_OBSERVERS_CREATEGRIDBUTPOSTPONEREFINEMENT2PEANO4_TOOLBOX_BLOCKSTRUCTURED_PROJECTPATCHONTOFACES0_H_
...
namespace euler {
namespace observers {
  class CreateGridButPostponeRefinement2peano4_toolbox_blockstructured_ProjectPatchOntoFaces0;
}
}
}
}
class examples::exahype2::euler::observers::CreateGridButPostponeRefinement2peano4_toolbox_blockstructured_ProjectPatchOntoFaces0{
  private:
  ...
  public:
     ...
     */      
    CreateGridButPostponeRefinement2peano4_toolbox_blockstructured_ProjectPatchOntoFaces0(int treeNumber);

    ~CreateGridButPostponeRefinement2peano4_toolbox_blockstructured_ProjectPatchOntoFaces0();
