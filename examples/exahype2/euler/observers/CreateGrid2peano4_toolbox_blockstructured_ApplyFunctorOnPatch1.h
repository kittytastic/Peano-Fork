#ifndef _EXAMPLES_EXAHYPE2_EULER_OBSERVERS_CREATEGRID2PEANO4_TOOLBOX_BLOCKSTRUCTURED_APPLYFUNCTORONPATCH1_H_
#define _EXAMPLES_EXAHYPE2_EULER_OBSERVERS_CREATEGRID2PEANO4_TOOLBOX_BLOCKSTRUCTURED_APPLYFUNCTORONPATCH1_H_
...
namespace euler {
namespace observers {
  class CreateGrid2peano4_toolbox_blockstructured_ApplyFunctorOnPatch1;
}
}
}
}
class examples::exahype2::euler::observers::CreateGrid2peano4_toolbox_blockstructured_ApplyFunctorOnPatch1{
  private:
  ...
  public:
     ...
     */      
    CreateGrid2peano4_toolbox_blockstructured_ApplyFunctorOnPatch1(int treeNumber);

    ~CreateGrid2peano4_toolbox_blockstructured_ApplyFunctorOnPatch1();
