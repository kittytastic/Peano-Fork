#ifndef _EXAMPLES_EXAHYPE2_EULER_OBSERVERS_TIMESTEP2PEANO4_TOOLBOX_BLOCKSTRUCTURED_APPLYFUNCTORONPATCH6_H_
#define _EXAMPLES_EXAHYPE2_EULER_OBSERVERS_TIMESTEP2PEANO4_TOOLBOX_BLOCKSTRUCTURED_APPLYFUNCTORONPATCH6_H_
...
namespace euler {
namespace observers {
  class TimeStep2peano4_toolbox_blockstructured_ApplyFunctorOnPatch6;
}
}
}
}
class examples::exahype2::euler::observers::TimeStep2peano4_toolbox_blockstructured_ApplyFunctorOnPatch6{
  private:
  ...
  public:
     ...
     */      
    TimeStep2peano4_toolbox_blockstructured_ApplyFunctorOnPatch6(int treeNumber);

    ~TimeStep2peano4_toolbox_blockstructured_ApplyFunctorOnPatch6();
