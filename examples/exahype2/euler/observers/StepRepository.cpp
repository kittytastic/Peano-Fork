...
std::string examples::exahype2::euler::observers::StepRepository::toString( Steps value ) {
  switch (value) {
...
int examples::exahype2::euler::observers::StepRepository::toProgramStep( Steps value ) {
  switch (value) {
...
examples::exahype2::euler::observers::StepRepository::Steps examples::exahype2::euler::observers::StepRepository::toStepEnum( int value ) {
  switch (value) {
