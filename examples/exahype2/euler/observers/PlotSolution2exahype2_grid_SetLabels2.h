#ifndef _EXAMPLES_EXAHYPE2_EULER_OBSERVERS_PLOTSOLUTION2EXAHYPE2_GRID_SETLABELS2_H_
#define _EXAMPLES_EXAHYPE2_EULER_OBSERVERS_PLOTSOLUTION2EXAHYPE2_GRID_SETLABELS2_H_
...
namespace euler {
namespace observers {
  class PlotSolution2exahype2_grid_SetLabels2;
}
}
}
}
class examples::exahype2::euler::observers::PlotSolution2exahype2_grid_SetLabels2{
  private:
  ...
  public:
     ...
     */      
    PlotSolution2exahype2_grid_SetLabels2(int treeNumber);

    ~PlotSolution2exahype2_grid_SetLabels2();
