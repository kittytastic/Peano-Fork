#ifndef _EXAMPLES_EXAHYPE2_EULER_OBSERVERS_CREATEGRID2PEANO4_TOOLBOX_BLOCKSTRUCTURED_PROJECTPATCHONTOFACES0_H_
#define _EXAMPLES_EXAHYPE2_EULER_OBSERVERS_CREATEGRID2PEANO4_TOOLBOX_BLOCKSTRUCTURED_PROJECTPATCHONTOFACES0_H_
...
namespace euler {
namespace observers {
  class CreateGrid2peano4_toolbox_blockstructured_ProjectPatchOntoFaces0;
}
}
}
}
class examples::exahype2::euler::observers::CreateGrid2peano4_toolbox_blockstructured_ProjectPatchOntoFaces0{
  private:
  ...
  public:
     ...
     */      
    CreateGrid2peano4_toolbox_blockstructured_ProjectPatchOntoFaces0(int treeNumber);

    ~CreateGrid2peano4_toolbox_blockstructured_ProjectPatchOntoFaces0();
