#ifndef _EXAMPLES_EXAHYPE2_EULER_OBSERVERS_CREATEGRID2EXAHYPE2_GRID_ENCLAVELABELS2_H_
#define _EXAMPLES_EXAHYPE2_EULER_OBSERVERS_CREATEGRID2EXAHYPE2_GRID_ENCLAVELABELS2_H_
...
namespace euler {
namespace observers {
  class CreateGrid2exahype2_grid_EnclaveLabels2;
}
}
}
}
class examples::exahype2::euler::observers::CreateGrid2exahype2_grid_EnclaveLabels2{
  private:
  ...
  public:
     ...
     */      
    CreateGrid2exahype2_grid_EnclaveLabels2(int treeNumber);

    ~CreateGrid2exahype2_grid_EnclaveLabels2();
