...
using namespace examples::exahype2::euler;
...
int main(int argc, char** argv) {
  ...
  examples::exahype2::euler::observers::DataRepository::initDatatypes();
  ...
  examples::exahype2::euler::observers::DataRepository::shutdownDatatypes();
