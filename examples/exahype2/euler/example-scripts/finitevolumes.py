...
parser.add_argument("-t",   "--type",                  dest="type",                     choices=["global-fixed", "global-adaptive", "global-fixed-enclave", "global-adaptive-enclave", "global-fixed-enclave-gpu", "global-adaptive-enclave-gpu", "subcycling-fixed"], default="global-fixed", help="Pick implementation variant" )
...
elif args.type=="subcycling-fixed":
