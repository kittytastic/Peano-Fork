...
project.add_action_set_to_timestepping( exahype2.tracer.DumpTrajectoryIntoDatabase(tracer_particles,particle_spacing,"TracerDB") )
#project.add_action_set_to_timestepping( exahype2.tracer.Apply(tracer_particles,particle_spacing) )
