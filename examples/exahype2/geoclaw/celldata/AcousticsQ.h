...
//
#ifndef _examples_exahype2_acoustics_celldata_AcousticsQ_H_
#define _examples_exahype2_acoustics_celldata_AcousticsQ_H_
...
namespace examples {namespace exahype2 {namespace acoustics {namespace celldata {
...
struct examples::exahype2::acoustics::celldata::AcousticsQ {
  #if PeanoDebug>=1
  private:
  ...
  void merge(const AcousticsQ& neighbour, const peano4::datamanagement::CellMarker& marker);
