...
// here
//  
#ifndef _INCLUDE_EXAMPLES_EXAHYPE2_ACOUSTICS_FACEDATA_LABEL_
#define _INCLUDE_EXAMPLES_EXAHYPE2_ACOUSTICS_FACEDATA_LABEL_
...
struct examples::exahype2::acoustics::facedata::Label {
  public:
     ...
     * blocking MPI_Send. 
     */
    static void send(const examples::exahype2::acoustics::facedata::Label& buffer, int destination, int tag, MPI_Comm communicator );
    static void receive(examples::exahype2::acoustics::facedata::Label& buffer, int source, int tag, MPI_Comm communicator );
     ...
     */
    static void send(const examples::exahype2::acoustics::facedata::Label& buffer, int destination, int tag, std::function<void()> waitFunctor, MPI_Comm communicator );
    static void receive(examples::exahype2::acoustics::facedata::Label& buffer, int source, int tag, std::function<void()> waitFunctor, MPI_Comm communicator );
    #endif


#ifdef Parallel
    static void sendAndPollDanglingMessages(const examples::exahype2::acoustics::facedata::Label& message, int destination, int tag );
    static void receiveAndPollDanglingMessages(examples::exahype2::acoustics::facedata::Label& message, int source, int tag );
#endif
    
    void merge(const examples::exahype2::acoustics::facedata::Label& neighbour, const peano4::datamanagement::FaceMarker& marker);
