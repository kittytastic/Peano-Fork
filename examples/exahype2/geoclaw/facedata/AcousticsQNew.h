...
//
#ifndef _examples_exahype2_acoustics_facedata_AcousticsQNew_H_
#define _examples_exahype2_acoustics_facedata_AcousticsQNew_H_
...
struct examples::exahype2::acoustics::facedata::AcousticsQNew {
  #if PeanoDebug>=1
  private:
  ...
  AcousticsQNew();
  AcousticsQNew(const AcousticsQNew& other);
  AcousticsQNew& operator=(const AcousticsQNew& other);

  std::string toString() const;
  
  void merge(const AcousticsQNew& neighbour, const peano4::datamanagement::FaceMarker& marker);
