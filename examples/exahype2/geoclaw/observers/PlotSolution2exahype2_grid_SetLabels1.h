#ifndef _EXAMPLES_EXAHYPE2_ACOUSTICS_OBSERVERS_PLOTSOLUTION2EXAHYPE2_GRID_SETLABELS1_H_
#define _EXAMPLES_EXAHYPE2_ACOUSTICS_OBSERVERS_PLOTSOLUTION2EXAHYPE2_GRID_SETLABELS1_H_
...
namespace acoustics {
namespace observers {
  class PlotSolution2exahype2_grid_SetLabels1;
}
}
}
}
class examples::exahype2::acoustics::observers::PlotSolution2exahype2_grid_SetLabels1{
  private:
  ...
  public:
     ...
     */      
    PlotSolution2exahype2_grid_SetLabels1(int treeNumber);

    ~PlotSolution2exahype2_grid_SetLabels1();
