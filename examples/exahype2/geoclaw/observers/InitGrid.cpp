...
tarch::logging::Log examples::exahype2::acoustics::observers::InitGrid::_log( "examples::exahype2::acoustics::observers::InitGrid" );


  
examples::exahype2::acoustics::observers::InitGrid::InitGrid(int spacetreeId):
...
peano4::grid::TraversalObserver* examples::exahype2::acoustics::observers::InitGrid::clone(int spacetreeId) {
  return new InitGrid(spacetreeId);
}
  
  
  
std::vector< peano4::grid::GridControlEvent > examples::exahype2::acoustics::observers::InitGrid::getGridControlEvents() const {
...
void examples::exahype2::acoustics::observers::InitGrid::beginTraversal( const tarch::la::Vector<Dimensions,double>&  x, const tarch::la::Vector<Dimensions,double>&  h ) {
...
void examples::exahype2::acoustics::observers::InitGrid::endTraversal( const tarch::la::Vector<Dimensions,double>&  x, const tarch::la::Vector<Dimensions,double>&  h ) {
...
void examples::exahype2::acoustics::observers::InitGrid::enterCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void examples::exahype2::acoustics::observers::InitGrid::leaveCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void examples::exahype2::acoustics::observers::InitGrid::exchangeAllVerticalDataExchangeStacks( int masterId ) {
...
void examples::exahype2::acoustics::observers::InitGrid::exchangeAllHorizontalDataExchangeStacks( bool symmetricDataCardinality ) {
...
void examples::exahype2::acoustics::observers::InitGrid::exchangeAllPeriodicBoundaryDataStacks() {
...
void examples::exahype2::acoustics::observers::InitGrid::streamDataFromSplittingTreeToNewTree(int newWorker) {
...
void examples::exahype2::acoustics::observers::InitGrid::streamDataFromJoiningTreeToMasterTree(int master) {
...
void examples::exahype2::acoustics::observers::InitGrid::finishAllOutstandingSendsAndReceives() {
...
void examples::exahype2::acoustics::observers::InitGrid::sendVertex(int inOutStack, int relativePositionOnInOutStack, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::datamanagement::VertexMarker& marker) {
...
void examples::exahype2::acoustics::observers::InitGrid::sendFace(int inOutStack, int relativePositionOnInOutStack, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::datamanagement::FaceMarker& marker) {
...
void examples::exahype2::acoustics::observers::InitGrid::sendCell(int inOutStack, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::datamanagement::CellMarker& marker) {
...
void examples::exahype2::acoustics::observers::InitGrid::deleteAllStacks() {
