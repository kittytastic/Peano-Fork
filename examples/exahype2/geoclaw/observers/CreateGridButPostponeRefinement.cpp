...
tarch::logging::Log examples::exahype2::acoustics::observers::CreateGridButPostponeRefinement::_log( "examples::exahype2::acoustics::observers::CreateGridButPostponeRefinement" );


  
examples::exahype2::acoustics::observers::CreateGridButPostponeRefinement::CreateGridButPostponeRefinement(int spacetreeId):
  _spacetreeId( spacetreeId ) , _actionSet0(spacetreeId), _actionSet1(spacetreeId)
{
}
...
peano4::grid::TraversalObserver* examples::exahype2::acoustics::observers::CreateGridButPostponeRefinement::clone(int spacetreeId) {
  return new CreateGridButPostponeRefinement(spacetreeId);
}
  
  
  
std::vector< peano4::grid::GridControlEvent > examples::exahype2::acoustics::observers::CreateGridButPostponeRefinement::getGridControlEvents() const {
...
void examples::exahype2::acoustics::observers::CreateGridButPostponeRefinement::beginTraversal( const tarch::la::Vector<Dimensions,double>&  x, const tarch::la::Vector<Dimensions,double>&  h ) {
...
void examples::exahype2::acoustics::observers::CreateGridButPostponeRefinement::endTraversal( const tarch::la::Vector<Dimensions,double>&  x, const tarch::la::Vector<Dimensions,double>&  h ) {
...
void examples::exahype2::acoustics::observers::CreateGridButPostponeRefinement::enterCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void examples::exahype2::acoustics::observers::CreateGridButPostponeRefinement::leaveCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void examples::exahype2::acoustics::observers::CreateGridButPostponeRefinement::exchangeAllVerticalDataExchangeStacks( int masterId ) {
...
void examples::exahype2::acoustics::observers::CreateGridButPostponeRefinement::exchangeAllHorizontalDataExchangeStacks( bool symmetricDataCardinality ) {
...
void examples::exahype2::acoustics::observers::CreateGridButPostponeRefinement::exchangeAllPeriodicBoundaryDataStacks() {
...
void examples::exahype2::acoustics::observers::CreateGridButPostponeRefinement::streamDataFromSplittingTreeToNewTree(int newWorker) {
...
void examples::exahype2::acoustics::observers::CreateGridButPostponeRefinement::streamDataFromJoiningTreeToMasterTree(int master) {
...
void examples::exahype2::acoustics::observers::CreateGridButPostponeRefinement::finishAllOutstandingSendsAndReceives() {
...
void examples::exahype2::acoustics::observers::CreateGridButPostponeRefinement::sendVertex(int inOutStack, int relativePositionOnInOutStack, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::datamanagement::VertexMarker& marker) {
...
void examples::exahype2::acoustics::observers::CreateGridButPostponeRefinement::sendFace(int inOutStack, int relativePositionOnInOutStack, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::datamanagement::FaceMarker& marker) {
...
void examples::exahype2::acoustics::observers::CreateGridButPostponeRefinement::sendCell(int inOutStack, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::datamanagement::CellMarker& marker) {
...
void examples::exahype2::acoustics::observers::CreateGridButPostponeRefinement::deleteAllStacks() {
