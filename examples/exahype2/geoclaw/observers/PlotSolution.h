...
#ifndef _examples_exahype2_acoustics_observers_PlotSolution_H_
#define _examples_exahype2_acoustics_observers_PlotSolution_H_
...
class examples::exahype2::acoustics::observers::PlotSolution: public peano4::grid::TraversalObserver {
  public:
    /**
     * Logging device
     */
