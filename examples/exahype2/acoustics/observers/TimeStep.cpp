...
tarch::logging::Log examples::exahype2::acoustics::observers::TimeStep::_log( "examples::exahype2::acoustics::observers::TimeStep" );


  
examples::exahype2::acoustics::observers::TimeStep::TimeStep(int spacetreeId):
...
peano4::grid::TraversalObserver* examples::exahype2::acoustics::observers::TimeStep::clone(int spacetreeId) {
  return new TimeStep(spacetreeId);
}
  
  
  
std::vector< peano4::grid::GridControlEvent > examples::exahype2::acoustics::observers::TimeStep::getGridControlEvents() const {
...
void examples::exahype2::acoustics::observers::TimeStep::beginTraversal( const tarch::la::Vector<Dimensions,double>&  x, const tarch::la::Vector<Dimensions,double>&  h ) {
...
void examples::exahype2::acoustics::observers::TimeStep::endTraversal( const tarch::la::Vector<Dimensions,double>&  x, const tarch::la::Vector<Dimensions,double>&  h ) {
...
void examples::exahype2::acoustics::observers::TimeStep::enterCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void examples::exahype2::acoustics::observers::TimeStep::leaveCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void examples::exahype2::acoustics::observers::TimeStep::exchangeAllVerticalDataExchangeStacks( int masterId ) {
...
void examples::exahype2::acoustics::observers::TimeStep::exchangeAllHorizontalDataExchangeStacks( bool symmetricDataCardinality ) {
...
void examples::exahype2::acoustics::observers::TimeStep::exchangeAllPeriodicBoundaryDataStacks() {
...
void examples::exahype2::acoustics::observers::TimeStep::streamDataFromSplittingTreeToNewTree(int newWorker) {
...
void examples::exahype2::acoustics::observers::TimeStep::streamDataFromJoiningTreeToMasterTree(int master) {
...
void examples::exahype2::acoustics::observers::TimeStep::finishAllOutstandingSendsAndReceives() {
...
void examples::exahype2::acoustics::observers::TimeStep::sendVertex(int inOutStack, int relativePositionOnInOutStack, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::datamanagement::VertexMarker& marker) {
...
void examples::exahype2::acoustics::observers::TimeStep::sendFace(int inOutStack, int relativePositionOnInOutStack, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::datamanagement::FaceMarker& marker) {
...
void examples::exahype2::acoustics::observers::TimeStep::sendCell(int inOutStack, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::datamanagement::CellMarker& marker) {
...
void examples::exahype2::acoustics::observers::TimeStep::deleteAllStacks() {
