#ifndef _EXAMPLES_EXAHYPE2_ACOUSTICS_OBSERVERS_TIMESTEP2EXAHYPE2_GRID_AMRONPATCH3_H_
#define _EXAMPLES_EXAHYPE2_ACOUSTICS_OBSERVERS_TIMESTEP2EXAHYPE2_GRID_AMRONPATCH3_H_
...
namespace acoustics {
namespace observers {
  class TimeStep2exahype2_grid_AMROnPatch3;
}
}
}
}
class examples::exahype2::acoustics::observers::TimeStep2exahype2_grid_AMROnPatch3{
  private:
  ...
  public:
     ...
     */      
    TimeStep2exahype2_grid_AMROnPatch3(int treeNumber);

    ~TimeStep2exahype2_grid_AMROnPatch3();
