#ifndef _EXAMPLES_EXAHYPE2_ACOUSTICS_OBSERVERS_TIMESTEP2PEANO4_TOOLBOX_BLOCKSTRUCTURED_RECONSTRUCTPATCHANDAPPLYFUNCTOR0_H_
#define _EXAMPLES_EXAHYPE2_ACOUSTICS_OBSERVERS_TIMESTEP2PEANO4_TOOLBOX_BLOCKSTRUCTURED_RECONSTRUCTPATCHANDAPPLYFUNCTOR0_H_
...
namespace acoustics {
namespace observers {
  class TimeStep2peano4_toolbox_blockstructured_ReconstructPatchAndApplyFunctor0;
}
}
}
}
class examples::exahype2::acoustics::observers::TimeStep2peano4_toolbox_blockstructured_ReconstructPatchAndApplyFunctor0{
  private:
...
int  _treeNumber;
  public:
     ...
     */      
    TimeStep2peano4_toolbox_blockstructured_ReconstructPatchAndApplyFunctor0(int treeNumber);

    ~TimeStep2peano4_toolbox_blockstructured_ReconstructPatchAndApplyFunctor0();
