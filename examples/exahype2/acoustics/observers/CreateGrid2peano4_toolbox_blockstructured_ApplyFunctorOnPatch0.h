#ifndef _EXAMPLES_EXAHYPE2_ACOUSTICS_OBSERVERS_CREATEGRID2PEANO4_TOOLBOX_BLOCKSTRUCTURED_APPLYFUNCTORONPATCH0_H_
#define _EXAMPLES_EXAHYPE2_ACOUSTICS_OBSERVERS_CREATEGRID2PEANO4_TOOLBOX_BLOCKSTRUCTURED_APPLYFUNCTORONPATCH0_H_
...
namespace acoustics {
namespace observers {
  class CreateGrid2peano4_toolbox_blockstructured_ApplyFunctorOnPatch0;
}
}
}
}
class examples::exahype2::acoustics::observers::CreateGrid2peano4_toolbox_blockstructured_ApplyFunctorOnPatch0{
  private:
  ...
  public:
     ...
     */      
    CreateGrid2peano4_toolbox_blockstructured_ApplyFunctorOnPatch0(int treeNumber);

    ~CreateGrid2peano4_toolbox_blockstructured_ApplyFunctorOnPatch0();
