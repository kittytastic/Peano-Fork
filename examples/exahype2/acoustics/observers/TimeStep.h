...
#ifndef _examples_exahype2_acoustics_observers_TimeStep_H_
#define _examples_exahype2_acoustics_observers_TimeStep_H_
...
#include "observers/TimeStep2exahype2_grid_SetLabels5.h"
...
class examples::exahype2::acoustics::observers::TimeStep: public peano4::grid::TraversalObserver {
  public:
    /**
     * Logging device
     */
    ...
    observers::TimeStep2exahype2_grid_SetLabels5   _actionSet5; 
