#ifndef _EXAMPLES_EXAHYPE2_ACOUSTICS_OBSERVERS_CREATEGRID2EXAHYPE2_GRID_SETLABELS2_H_
#define _EXAMPLES_EXAHYPE2_ACOUSTICS_OBSERVERS_CREATEGRID2EXAHYPE2_GRID_SETLABELS2_H_
...
namespace acoustics {
namespace observers {
  class CreateGrid2exahype2_grid_SetLabels2;
}
}
}
}
class examples::exahype2::acoustics::observers::CreateGrid2exahype2_grid_SetLabels2{
  private:
  ...
  public:
     ...
     */      
    CreateGrid2exahype2_grid_SetLabels2(int treeNumber);

    ~CreateGrid2exahype2_grid_SetLabels2();
