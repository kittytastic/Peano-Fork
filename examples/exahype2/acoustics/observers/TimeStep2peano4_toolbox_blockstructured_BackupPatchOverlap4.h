#ifndef _EXAMPLES_EXAHYPE2_ACOUSTICS_OBSERVERS_TIMESTEP2PEANO4_TOOLBOX_BLOCKSTRUCTURED_BACKUPPATCHOVERLAP4_H_
#define _EXAMPLES_EXAHYPE2_ACOUSTICS_OBSERVERS_TIMESTEP2PEANO4_TOOLBOX_BLOCKSTRUCTURED_BACKUPPATCHOVERLAP4_H_
...
namespace acoustics {
namespace observers {
  class TimeStep2peano4_toolbox_blockstructured_BackupPatchOverlap4;
}
}
}
}
class examples::exahype2::acoustics::observers::TimeStep2peano4_toolbox_blockstructured_BackupPatchOverlap4{
  private:
  ...
  public:
     ...
     */      
    TimeStep2peano4_toolbox_blockstructured_BackupPatchOverlap4(int treeNumber);
