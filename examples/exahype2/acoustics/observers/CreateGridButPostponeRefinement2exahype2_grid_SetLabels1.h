#ifndef _EXAMPLES_EXAHYPE2_ACOUSTICS_OBSERVERS_CREATEGRIDBUTPOSTPONEREFINEMENT2EXAHYPE2_GRID_SETLABELS1_H_
#define _EXAMPLES_EXAHYPE2_ACOUSTICS_OBSERVERS_CREATEGRIDBUTPOSTPONEREFINEMENT2EXAHYPE2_GRID_SETLABELS1_H_
...
namespace acoustics {
namespace observers {
  class CreateGridButPostponeRefinement2exahype2_grid_SetLabels1;
}
}
}
}
class examples::exahype2::acoustics::observers::CreateGridButPostponeRefinement2exahype2_grid_SetLabels1{
  private:
  ...
  public:
     ...
     */      
    CreateGridButPostponeRefinement2exahype2_grid_SetLabels1(int treeNumber);

    ~CreateGridButPostponeRefinement2exahype2_grid_SetLabels1();
