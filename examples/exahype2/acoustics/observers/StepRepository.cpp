...
std::string examples::exahype2::acoustics::observers::StepRepository::toString( Steps value ) {
  switch (value) {
...
int examples::exahype2::acoustics::observers::StepRepository::toProgramStep( Steps value ) {
  switch (value) {
...
examples::exahype2::acoustics::observers::StepRepository::Steps examples::exahype2::acoustics::observers::StepRepository::toStepEnum( int value ) {
  switch (value) {
