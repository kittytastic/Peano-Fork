#ifndef _EXAMPLES_EXAHYPE2_ACOUSTICS_OBSERVERS_INITGRID2PEANO4_TOOLBOX_BLOCKSTRUCTURED_PROJECTPATCHONTOFACES1_H_
#define _EXAMPLES_EXAHYPE2_ACOUSTICS_OBSERVERS_INITGRID2PEANO4_TOOLBOX_BLOCKSTRUCTURED_PROJECTPATCHONTOFACES1_H_
...
namespace acoustics {
namespace observers {
  class InitGrid2peano4_toolbox_blockstructured_ProjectPatchOntoFaces1;
}
}
}
}
class examples::exahype2::acoustics::observers::InitGrid2peano4_toolbox_blockstructured_ProjectPatchOntoFaces1{
  private:
  ...
  public:
     ...
     */      
    InitGrid2peano4_toolbox_blockstructured_ProjectPatchOntoFaces1(int treeNumber);

    ~InitGrid2peano4_toolbox_blockstructured_ProjectPatchOntoFaces1();
