...
tarch::logging::Log examples::exahype2::acoustics::observers::PlotSolution::_log( "examples::exahype2::acoustics::observers::PlotSolution" );


  
examples::exahype2::acoustics::observers::PlotSolution::PlotSolution(int spacetreeId):
...
peano4::grid::TraversalObserver* examples::exahype2::acoustics::observers::PlotSolution::clone(int spacetreeId) {
  return new PlotSolution(spacetreeId);
}
  
  
  
std::vector< peano4::grid::GridControlEvent > examples::exahype2::acoustics::observers::PlotSolution::getGridControlEvents() const {
...
void examples::exahype2::acoustics::observers::PlotSolution::beginTraversal( const tarch::la::Vector<Dimensions,double>&  x, const tarch::la::Vector<Dimensions,double>&  h ) {
...
void examples::exahype2::acoustics::observers::PlotSolution::endTraversal( const tarch::la::Vector<Dimensions,double>&  x, const tarch::la::Vector<Dimensions,double>&  h ) {
...
void examples::exahype2::acoustics::observers::PlotSolution::enterCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void examples::exahype2::acoustics::observers::PlotSolution::leaveCell( const peano4::grid::GridTraversalEvent&  event ) {
...
void examples::exahype2::acoustics::observers::PlotSolution::exchangeAllVerticalDataExchangeStacks( int masterId ) {
...
void examples::exahype2::acoustics::observers::PlotSolution::exchangeAllHorizontalDataExchangeStacks( bool symmetricDataCardinality ) {
...
void examples::exahype2::acoustics::observers::PlotSolution::exchangeAllPeriodicBoundaryDataStacks() {
...
void examples::exahype2::acoustics::observers::PlotSolution::streamDataFromSplittingTreeToNewTree(int newWorker) {
...
void examples::exahype2::acoustics::observers::PlotSolution::streamDataFromJoiningTreeToMasterTree(int master) {
...
void examples::exahype2::acoustics::observers::PlotSolution::finishAllOutstandingSendsAndReceives() {
...
void examples::exahype2::acoustics::observers::PlotSolution::sendVertex(int inOutStack, int relativePositionOnInOutStack, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::datamanagement::VertexMarker& marker) {
...
void examples::exahype2::acoustics::observers::PlotSolution::sendFace(int inOutStack, int relativePositionOnInOutStack, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::datamanagement::FaceMarker& marker) {
...
void examples::exahype2::acoustics::observers::PlotSolution::sendCell(int inOutStack, int toStack, ::peano4::grid::TraversalObserver::SendReceiveContext context, const peano4::datamanagement::CellMarker& marker) {
...
void examples::exahype2::acoustics::observers::PlotSolution::deleteAllStacks() {
