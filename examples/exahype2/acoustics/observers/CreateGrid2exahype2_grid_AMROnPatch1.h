#ifndef _EXAMPLES_EXAHYPE2_ACOUSTICS_OBSERVERS_CREATEGRID2EXAHYPE2_GRID_AMRONPATCH1_H_
#define _EXAMPLES_EXAHYPE2_ACOUSTICS_OBSERVERS_CREATEGRID2EXAHYPE2_GRID_AMRONPATCH1_H_
...
namespace acoustics {
namespace observers {
  class CreateGrid2exahype2_grid_AMROnPatch1;
}
}
}
}
class examples::exahype2::acoustics::observers::CreateGrid2exahype2_grid_AMROnPatch1{
  private:
  ...
  public:
     ...
     */      
    CreateGrid2exahype2_grid_AMROnPatch1(int treeNumber);
