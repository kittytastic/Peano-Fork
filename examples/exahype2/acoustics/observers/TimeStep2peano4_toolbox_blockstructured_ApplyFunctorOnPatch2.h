#ifndef _EXAMPLES_EXAHYPE2_ACOUSTICS_OBSERVERS_TIMESTEP2PEANO4_TOOLBOX_BLOCKSTRUCTURED_APPLYFUNCTORONPATCH2_H_
#define _EXAMPLES_EXAHYPE2_ACOUSTICS_OBSERVERS_TIMESTEP2PEANO4_TOOLBOX_BLOCKSTRUCTURED_APPLYFUNCTORONPATCH2_H_
...
namespace acoustics {
namespace observers {
  class TimeStep2peano4_toolbox_blockstructured_ApplyFunctorOnPatch2;
}
}
}
}
class examples::exahype2::acoustics::observers::TimeStep2peano4_toolbox_blockstructured_ApplyFunctorOnPatch2{
  private:
  ...
  public:
     ...
     */      
    TimeStep2peano4_toolbox_blockstructured_ApplyFunctorOnPatch2(int treeNumber);

    ~TimeStep2peano4_toolbox_blockstructured_ApplyFunctorOnPatch2();
