...
#ifndef _examples_exahype2_acoustics_observers_InitGrid_H_
#define _examples_exahype2_acoustics_observers_InitGrid_H_
...
class examples::exahype2::acoustics::observers::InitGrid: public peano4::grid::TraversalObserver {
  public:
    /**
     * Logging device
     */
