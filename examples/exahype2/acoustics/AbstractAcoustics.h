...
//
#ifndef _examples_exahype2_acoustics_AbstractAcoustics_H_
#define _examples_exahype2_acoustics_AbstractAcoustics_H_
 ...
 */
extern "C" int rp1_ptwise_(int* num_eqn, int* num_aux, int* num_waves, double* q_l, double* q_r, double* aux_l, double* aux_r, double* wave, double* s, double* amdq, double* apdq);



namespace examples {namespace exahype2 {namespace acoustics {
  class AbstractAcoustics;

}}}



class examples::exahype2::acoustics::AbstractAcoustics: public ::exahype2::Solver {
  public:
