...
if __name__ == "__main__":
    ...
    parser.add_argument("-maxh",   "--max-h",       dest="max_h",           type=float, default=0,  help="upper limit for refinement (set to 0 to make it equal to min_h - default)" )
    ...
    if is_aderdg:
      my_solver = exahype2.solvers.aderdg.NonFusedGenericRusanovFixedTimeStepSize(
          ...
          args.min_h, max_h, time_step_size,
          flux = None,
