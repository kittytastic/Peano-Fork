...
void Parameters::PrintParameters() {
	...
	TP_INFO ("Impact parameter par_b: %f", par_b);
	TP_INFO ("Center offset: [%f,%f,%f]", center_offset[0], center_offset[1], center_offset[2]);
	TP_INFO ("Grid setup method: %s", grid_setup_method.c_str());
	TP_INFO ("Lapse smearing epsilon: %e", TP_epsilon);
}
} // namespace
